 ...
 *
 */
(self["webpackChunkgethue"] = self["webpackChunkgethue"] || []).push([["hue-8c9fb242"],{
...
var DisposableComponent = /*#__PURE__*/function () {
  ...
  _createClass(DisposableComponent, [{
    key: "subscribe",
...
var findNameInHierarchy = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(entry, searchCondition) {
...
var AssistDbEntry = /*#__PURE__*/function () {
  ...
  _createClass(AssistDbEntry, [{
    ...
    key: "getDatabaseName",
    value: function () {
      var _getDatabaseName = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    ...
    key: "getTableName",
    value: function () {
      var _getTableName = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    ...
    key: "getColumnName",
    value: function () {
      var _getColumnName = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
    ...
    key: "getComplexName",
    value: function () {
      var _getComplexName = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
    ...
    key: "dblClick",
    value: function () {
      var _dblClick = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
        var self;
    ...
    key: "explore",
    value: function () {
      var _explore = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(isSolr) {
        var self;
...
var AssistDbNamespace = /*#__PURE__*/function () {
  ...
  function AssistDbNamespace(options) {
    ...
    self.status = knockout__WEBPACK_IMPORTED_MODULE_2__.observable(options.namespace.status); // TODO: Compute selection in assist?
...
var AssistDbSource = /*#__PURE__*/function () {
  ...
  function AssistDbSource(options) {
    ...
    var self = this; // TODO: Get rid of sourceType
...
var AssistStorageEntry = /*#__PURE__*/function () {
  ...
  _createClass(AssistStorageEntry, [{
    ...
    value: function getEntry(path, type) {
      ...
      type = type.replace(/abfs.*/i, 'abfs'); // TODO: connector.id for browser connectors
...
var AssistDashboardPanel = function AssistDashboardPanel() {
  var _this = this;
...
var AssistDbPanel = /*#__PURE__*/function () {
  ...
  function AssistDbPanel(options) {
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.subscribe(_events__WEBPACK_IMPORTED_MODULE_2__.ASSIST_IS_DB_PANEL_READY_EVENT, function () {
      utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.publish(_events__WEBPACK_IMPORTED_MODULE_2__.ASSIST_DB_PANEL_IS_READY_EVENT);
    });
  }

  _createClass(AssistDbPanel, [{
...
var AssistDocumentsPanel = /*#__PURE__*/function () {
  ...
  _createClass(AssistDocumentsPanel, [{
    key: "setTypeFilter",
...
var AssistantUtils = /*#__PURE__*/function () {
  ...
  _createClass(AssistantUtils, null, [{
...
var AssistEditorContextPanel = /*#__PURE__*/function () {
  function AssistEditorContextPanel(params) {
    ...
    var i18n = {};
    var sources = {};
    var loadEntriesTimeout = -1; // This fetches the columns for each table synchronously with 2 second in between.
    ...
    var loadEntries = function loadEntries(currentCount) {
      ...
      if (_this.activeTables().length === 1) {
        _this.activeTables()[0].open(true);
      } else {
                    ...
                    catalogEntry.reload = function () {
                      ...
                      catalog_dataCatalog__WEBPACK_IMPORTED_MODULE_6__.default.getEntry({
                        ...
                        sourceEntry.getChildren().then(function (dbEntries) {
                          var clearPromise; // Clear the database first if it exists without cascade
  ...
  _createClass(AssistEditorContextPanel, [{
    key: "addFilter",
  ...
  return AssistEditorContextPanel;
}();
...
var NAME = 'assist-functions-panel'; // prettier-ignore
...
var ConnectorUdfCategories = /*#__PURE__*/function () {
  ...
  _createClass(ConnectorUdfCategories, [{
    key: "init",
    value: function () {
    ...
    key: "getUdfs",
    value: function () {
      var _getUdfs = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
  ...
  return ConnectorUdfCategories;
}();

var AssistFunctionsPanel = function AssistFunctionsPanel(params) {
  var _this2 = this;
  ...
  this.activeConnectorUdfs.subscribe( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(activeConnectorUdfs) {
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
...
var NAME = 'assist-language-reference-panel'; // prettier-ignore
...
var LanguageReferenceTopic = /*#__PURE__*/function () {
  ...
  _createClass(LanguageReferenceTopic, [{
    key: "load",
    value: function load() {
      var _this2 = this;
  ...
  return LanguageReferenceTopic;
}();

var AssistLangRefPanel = function AssistLangRefPanel(params, element) {
  var _this3 = this;
...
function AssistPanel(params) {
  ...
  var self = this;
  var i18n = {
    errorLoadingDatabases: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_7__.default)('There was a problem loading the databases'),
    errorLoadingTablePreview: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_7__.default)('There was a problem loading the table preview')
  };
  var i18nCollections = {
    errorLoadingDatabases: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_7__.default)('There was a problem loading the indexes'),
    errorLoadingTablePreview: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_7__.default)('There was a problem loading the index preview')
  };
  ...
  (0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_8__.withLocalStorage)('assist.last.open.panel', self.lastOpenPanelType); // TODO: Support dynamic config changes
    ...
    if (clusterConfig && clusterConfig['app_config']) {
      ...
      if (appConfig['editor']) {
        var sqlPanel = new _assistInnerPanel__WEBPACK_IMPORTED_MODULE_4__.default({
          ...
          name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_7__.default)('SQL'),
          type: 'sql',
          icon: 'fa-database',
          minHeight: 75
        });
      ...
      if (appConfig.browser && appConfig.browser.interpreters) {
        var storageBrowsers = appConfig.browser.interpreters.filter(function (interpreter) {
          return interpreter.type === 'adls' || interpreter.type === 'hdfs' || interpreter.type === 's3' || interpreter.type === 'abfs';
        });
        ...
        if (storageBrowsers.length) {
          panels.push(new _assistInnerPanel__WEBPACK_IMPORTED_MODULE_4__.default({
            ...
            name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_7__.default)('Files'),
            type: 'files',
            icon: 'fa-files-o',
            minHeight: 50
          }));
        ...
        if (appConfig.browser.interpreter_names.indexOf('indexes') !== -1) {
          var solrPanel = new _assistInnerPanel__WEBPACK_IMPORTED_MODULE_4__.default({
            ...
            name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_7__.default)('Indexes'),
            type: 'solr',
            icon: 'fa-search-plus',
            minHeight: 75
          });
        ...
        if (appConfig.browser.interpreter_names.indexOf('kafka') !== -1) {
          var streamsPanel = new _assistInnerPanel__WEBPACK_IMPORTED_MODULE_4__.default({
            ...
            name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_7__.default)('Streams'),
            type: 'kafka',
            icon: 'fa-sitemap',
            minHeight: 75
          });
        ...
        if (appConfig.browser.interpreter_names.indexOf('hbase') !== -1) {
          panels.push(new _assistInnerPanel__WEBPACK_IMPORTED_MODULE_4__.default({
            ...
            name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_7__.default)('HBase'),
            type: 'hbase',
            icon: 'fa-th-large',
            minHeight: 50
          }));
      ...
      var documentsPanel = new _assistInnerPanel__WEBPACK_IMPORTED_MODULE_4__.default({
        ...
        name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_7__.default)('Documents'),
        type: 'documents',
        icon: 'fa-files-o',
      ...
      if (window.HAS_GIT) {
        panels.push(new _assistInnerPanel__WEBPACK_IMPORTED_MODULE_4__.default({
          ...
          name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_7__.default)('Git'),
          type: 'git',
          icon: 'fa-github',
          minHeight: 50,
          rightAlignIcon: true
...
var AssistSchedulePanel = function AssistSchedulePanel() {
  var _this = this;

  _classCallCheck(this, AssistSchedulePanel);

  this.selectedNotebook = knockout__WEBPACK_IMPORTED_MODULE_0__.observable(); // TODO: Move all the scheduler logic out of the notebook to here.
  ...
  utils_huePubSub__WEBPACK_IMPORTED_MODULE_2__.default.publish('get.selected.notebook'); // Hue 4
...
var AssistStoragePanel = /*#__PURE__*/function () {
  ...
  function AssistStoragePanel(options) {
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_5__.default.subscribe('assist.storage.go.home', function () {
      var path = _this.activeSource().type === 's3' || _this.activeSource().type === 'abfs' ? '/' : window.USER_HOME_DIR;
  ...
  _createClass(AssistStoragePanel, [{
    key: "loadPath",
...
var RightAssistPanel = /*#__PURE__*/function () {
  function RightAssistPanel(params) {
    ...
    this.functionsTabAvailable = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed(function () {
      return _this.connector() && (_this.connector().dialect === 'hive' || _this.connector().dialect === 'impala' || _this.connector().dialect === 'pig' || _this.connector().dialect === 'flink');
    });
    ...
    (0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_6__.withLocalStorage)('assist.last.open.right.panel', this.lastActiveTabEditor, EDITOR_ASSISTANT_TAB);
    this.lastActiveTabDashboard = knockout__WEBPACK_IMPORTED_MODULE_0__.observable();
    (0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_6__.withLocalStorage)('assist.last.open.right.panel.dashboard', this.lastActiveTabDashboard, DASHBOARD_ASSISTANT_TAB);
...
var componentUtils = /*#__PURE__*/function () {
  ...
  _createClass(componentUtils, null, [{
    key: "registerComponent",
    value: function () {
      var _registerComponent = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, model, template) {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
    ...
    value: function () {
      var _registerStaticComponent = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, model, template) {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
...
var AsteriskData = function AsteriskData(data, connector, namespace, compute, defaultDatabase) {
...
var AsteriskContextTabs = function AsteriskContextTabs(data, connector, namespace, compute, defaultDatabase) {
...
var CollectionContextTabs = /*#__PURE__*/function () {
  ...
  _createClass(CollectionContextTabs, [{
    key: "loadTerms",
...
var DataCatalogContext = /*#__PURE__*/function () {
  ...
  _createClass(DataCatalogContext, [{
    key: "setEntry",
...
var TEMPLATE_NAME = 'context-document-details'; // prettier-ignore
...
var DocumentContext = /*#__PURE__*/function () {
  function DocumentContext(data) {
    ...
    var self = this;
    self.disposals = []; // Adapt some details to a common format, the global search endpoint has different structure than the docs one
...
var TEMPLATE_NAME = 'context-popover-function-details'; // prettier-ignore
...
var FunctionContextTabs = function FunctionContextTabs(data, connector) {
  var _this = this;
...
var NAME = 'context-popover'; // prettier-ignore
...
var ContextPopoverViewModel = /*#__PURE__*/function () {
  ...
  _createClass(ContextPopoverViewModel, [{
    key: "dispose",
    value: function dispose() {
      var self = this;
  ...
  return ContextPopoverViewModel;
}();
...
var SqlContextContentsGlobalSearch = /*#__PURE__*/function () {
  function SqlContextContentsGlobalSearch(params) {
    ...
    self.close = params.globalSearch.close.bind(params.globalSearch); // These are currently not in the global search results
  ...
  _createClass(SqlContextContentsGlobalSearch, [{
    key: "dispose",
    value: function dispose() {
      var self = this;
  ...
  return SqlContextContentsGlobalSearch;
}();
...
var DOCUMENT_CONTEXT_FOOTER = 'document-context-footer'; // prettier-ignore
...
var DocumentContextFooter = function DocumentContextFooter(params) {
  var _this = this;
...
knockout__WEBPACK_IMPORTED_MODULE_1__.bindingHandlers[NAME] = {
  init: function init(element, valueAccessor, allBindings, viewModel, bindingContext) {
    ...
    $element.on('mouseleave.onHover', function () {
      ...
      clearTimeouts(); // Keep open if mouse moves to the context popover
...
var NAME = 'quick-query-context'; // prettier-ignore
...
var QuickQueryContext = /*#__PURE__*/function (_DisposableComponent) {
  ...
  var _super = _createSuper(QuickQueryContext);
  ...
  function QuickQueryContext(params) {
    ...
    _this.activeExecutable = knockout__WEBPACK_IMPORTED_MODULE_0__.observable(); // TODO: Switch over to connector in ko.simpleAceEditor
    ...
    _this.subscribe(config_events__WEBPACK_IMPORTED_MODULE_8__.CONFIG_REFRESHED_TOPIC, _this.updateFromConfig.bind(_assertThisInitialized(_this)));
  ...
  _createClass(QuickQueryContext, [{
...
var TEMPLATE_NAME = 'context-partition-details'; // prettier-ignore
...
var ResizeHelper = function ResizeHelper(orientation, leftAdjust, topAdjust, preventHideCallback) {
  ...
  self.resizeStop = function (event, ui) {
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_1__.default.publish('context.popover.resized'); // Delay or it will close the popover when releasing at the window borders
  ...
  switch (orientation) {
    case 'top':
      ...
      self.resize = function (event, ui) {
        resizeTopBottomHorizontal(event, ui); // TODO: Implement resize height limits when popover is above
      };
    ...
    case 'left':
      ...
      self.resize = function (event, ui) {
        resizeLeftRightVertical(event, ui); // TODO: Implement resize width limits when popover is on the left
      };
...
var NAME = 'link-sharing'; // prettier-ignore
...
var LinkSharing = /*#__PURE__*/function (_DisposableComponent) {
  ...
  var _super = _createSuper(LinkSharing);
  ...
  function LinkSharing(params) {
    ...
    _get((_thisSuper = _assertThisInitialized(_this), _getPrototypeOf(LinkSharing.prototype)), "subscribe", _thisSuper).call(_thisSuper, _this.perms, function (perms) {
  ...
  _createClass(LinkSharing, [{
    key: "createReadLink",
    value: function () {
      var _createReadLink = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
    ...
    key: "deactivateLink",
    value: function () {
      var _deactivateLink = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    key: "changePerm",
    value: function () {
      var _changePerm = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(permOption) {
        var response;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
...
var SHOWN_EVENT = 'doc.share.modal.shown'; // prettier-ignore
...
var ShareDocModal = /*#__PURE__*/function (_DisposableComponent) {
  ...
  var _super = _createSuper(ShareDocModal);
  ...
  _createClass(ShareDocModal, [{
    ...
    key: "initDocument",
    value: function () {
      var _initDocument = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(params) {
        var document;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
  ...
  return ShareDocModal;
}(_DisposableComponent__WEBPACK_IMPORTED_MODULE_6__.default);

var getDocument = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(params) {
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
                    ...
                    switch (_context4.prev = _context4.next) {
                      case 0:
                        ensureLoaded = /*#__PURE__*/function () {
                          var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(entry) {
                            return regeneratorRuntime.wrap(function _callee2$(_context2) {
                              while (1) {
                                switch (_context2.prev = _context2.next) {
                                  case 0:
                        ...
                        entry.load( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
                          return regeneratorRuntime.wrap(function _callee3$(_context3) {
                            while (1) {
                              switch (_context3.prev = _context3.next) {
                                case 0:
...
var NAME = 'catalog-entries-list'; // prettier-ignore
...
var SampleEnrichedEntry = /*#__PURE__*/function () {
  ...
  _createClass(SampleEnrichedEntry, [{
    key: "showContextPopover",
...
var CatalogEntriesList = /*#__PURE__*/function () {
  ...
  _createClass(CatalogEntriesList, [{
    key: "dispose",
    value: function dispose() {
      var self = this;
      window.clearTimeout(self.fetchSampleTimeout);
...
HueContextSelector.prototype.reload = function (type) {
  ...
  if (self[type.name]) {
    ...
    self[type.lastPromise] = catalog_contextCatalog__WEBPACK_IMPORTED_MODULE_4__.default[type.contextCatalogFn]({
      ...
      self[type.available](available); // If we only get one and hue is not configured for multi-cluster we always fallback to the returned
      ...
      self.reloadDatabaseThrottle = window.setTimeout(function () {
        ...
        catalog_dataCatalog__WEBPACK_IMPORTED_MODULE_5__.default.getEntry({
          ...
          sourceEntry.getChildren({
            ...
            var lastSelectedDb = (0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_9__.getFromLocalStorage)('assist_' + knockout__WEBPACK_IMPORTED_MODULE_1__.unwrap(self.connector).id + '_' + self[TYPES_INDEX.namespace.name]().id + '.lastSelectedDb');
            var updateAssist = lastSelectedDb !== '';
            ...
            if (updateAssist) {
              utils_huePubSub__WEBPACK_IMPORTED_MODULE_7__.default.publish(_assist_events__WEBPACK_IMPORTED_MODULE_2__.ASSIST_SET_DATABASE_EVENT, {
                connector: connector,
                namespace: self[TYPES_INDEX.namespace.name](),
                name: self.database()
              });
...
var HueDropDown = function HueDropDown(params, element) {
  ...
  self.dropDownVisible.subscribe(function (newValue) {
    ...
    if (newValue) {
      ...
      }, 0); // Right align the dropdown when outside the right edge
...
var EditorDroppableMenu = /*#__PURE__*/function (_DisposableComponent) {
  ...
  var _super = _createSuper(EditorDroppableMenu);
  ...
  function EditorDroppableMenu(params, element) {
    ...
    _get((_thisSuper = _assertThisInitialized(_this), _getPrototypeOf(EditorDroppableMenu.prototype)), "subscribe", _thisSuper).call(_thisSuper, _bindings_ko_draggableText__WEBPACK_IMPORTED_MODULE_6__.DRAGGABLE_TEXT_META_EVENT, _this.meta);

    _this.menu = knockout__WEBPACK_IMPORTED_MODULE_1__.bindingHandlers.contextMenu.initContextMenu($tableDropMenu, jquery__WEBPACK_IMPORTED_MODULE_0___default()('.content-panel'), /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
            ...
            case 2:
              jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click.' + NAME, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
    ...
    $parentDropTarget.droppable({
      ...
      drop: function drop(e, ui) {
        ...
        if (meta.type === 's3' || meta.type === 'hdfs' || meta.type === 'adls' || meta.type === 'abfs') {
  ...
  _createClass(EditorDroppableMenu, [{
    key: "insertValue",
...
var ExecutionAnalysis = /*#__PURE__*/function () {
  ...
  _createClass(ExecutionAnalysis, [{
    ...
    value: function updateHeatMap(data, counterName) {
      ...
      d3.select('.heatmap').call(tip); // Color gradient

      var colors = ['#f6faaa', '#9E0142'];
      var colorScale = d3.scale.linear().domain([0, 1]).interpolate(d3.interpolateHsl).range(colors); // Define map dimensions
      ...
      $heatmap.height((Math.trunc((data.data.length - 1) / cols) + 1) * (blockWidth + blockGap)); // Attribute functions
...
var FavoriteApp = /*#__PURE__*/function () {
  ...
  _createClass(FavoriteApp, [{
    ...
    value: function () {
      var _setAsFavoriteApp = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(vm, e) {
        var post, postParams;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
...
var GlobalSearch = /*#__PURE__*/function () {
  ...
  _createClass(GlobalSearch, [{
    ...
    value: function () {
      var _initializeFacetValues = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    ...
    value: function fetchResults(querySpec) {
      ...
      if (!docOnly && window.HAS_CATALOG) {
        ...
        var navQuery = querySpec.query; // Add * in front of each term unless already there
...
var HistoryPanel = /*#__PURE__*/function () {
  function HistoryPanel() {
    ...
    self.editorViewModel = new _apps_notebook_NotebookViewModel__WEBPACK_IMPORTED_MODULE_3__.default(null, '', {
      user: window.LOGGED_USERNAME,
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_5__.default.subscribe('notebook.task.submitted', function (resp) {
      ...
      self.editorViewModel.openNotebook(data.uuid, null, true, function () {
        ...
        notebook.snippets()[0].checkStatus(); // Add to history
...
var ImportDocumentsModal = function ImportDocumentsModal(params) {
  var _this = this;
...
var NAME = 'inline-autocomplete'; // prettier-ignore
...
var InlineAutocomplete = /*#__PURE__*/function () {
  ...
  _createClass(InlineAutocomplete, [{
    key: "updateQuerySpec",
    value: function updateQuerySpec() {
      var self = this; // TODO: Get cursor position and split to before and after
          ...
          if (!knownFacetValues[facet]) {
            ...
            Object.keys(self.lastParseResult.facets[facet]).forEach(function (value) {
              if (knownFacetValues[facet][value]) {
                ...
                var found = false; // Find the closest match, i.e. type:s -> type: [string, smallint, ...]
...
var JobBrowserPanel = function JobBrowserPanel(params) {
  ...
  utils_huePubSub__WEBPACK_IMPORTED_MODULE_3__.default.subscribe('hide.jobs.panel', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).off('resize', reposition);
    $jobsPanel.hide();
  });
  utils_huePubSub__WEBPACK_IMPORTED_MODULE_3__.default.subscribe('show.jobs.panel', function (options) {
  ...
  utils_huePubSub__WEBPACK_IMPORTED_MODULE_3__.default.subscribe('toggle.jobs.panel', function () {
  ...
  self.jobCounts = knockout__WEBPACK_IMPORTED_MODULE_1__.observable({
    yarn: 0,
    schedules: 0,
    history: 0
  });
  self.jobCount = knockout__WEBPACK_IMPORTED_MODULE_1__.pureComputed(function () {
    var total = 0;
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
    ...
    success: function success(response) {
      params.onePageViewModel.processHeaders(response).done(function (rawHtml) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#mini_jobbrowser').html(rawHtml); //ko.bindingHandlers.delayedOverflow.init($('#mini_jobbrowser')[0]);
      });
    }
  });
  ...
  if (!window.IS_K8S_ONLY) {
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_3__.default.subscribe('check.job.browser', checkYarnBrowserStatus);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_3__.default.subscribe('check.schedules.browser', checkScheduleBrowserStatus);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_3__.default.subscribe('check.history.browser', checkHistoryBrowserStatus);
  }
};
...
var PerformanceGraph = /*#__PURE__*/function () {
  function PerformanceGraph(params) {
    _classCallCheck(this, PerformanceGraph);
    ...
    self.availableGranularities = [{
      label: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('1 hour'),
      totalTime: 1000 * 60 * 60,
      initialWindow: 1000 * 60 * 10,
      step: 5 * 1000 // 5 seconds

    }, {
      label: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('8 hours'),
      totalTime: 1000 * 60 * 60 * 8,
      initialWindow: 1000 * 60 * 60 * 2,
      step: 15 * 1000 // 15 seconds

    }, {
      label: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('1 week'),
      totalTime: 1000 * 60 * 60 * 24 * 7,
      initialWindow: 1000 * 60 * 60 * 24,
      step: 5 * 60 * 1000 // Every 5 minutes

    }];
    self.selectedGranularity = knockout__WEBPACK_IMPORTED_MODULE_1__.observable(self.availableGranularities[(0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_5__.getFromLocalStorage)('warehouses.performanceGraphGranularity', 0)]);
    self.clusterName = knockout__WEBPACK_IMPORTED_MODULE_1__.observable(params.clusterName); // Load the initial data
        ...
        self.selectedGranularity.subscribe(function (granularity) {
          for (var i = 0; i < self.availableGranularities.length; i++) {
            if (granularity === self.availableGranularities[i]) {
              (0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_5__.setInLocalStorage)('warehouses.performanceGraphGranularity', i);
              break;
            }
          }
  ...
  _createClass(PerformanceGraph, [{
    key: "showLoadingMessage",
    value: function showLoadingMessage() {
      var self = this;
      d3__WEBPACK_IMPORTED_MODULE_0__.select(self.graphElement).select('svg').remove();
      var svg = d3__WEBPACK_IMPORTED_MODULE_0__.select(self.graphElement).append('svg').attr('width', self.graphWidth).attr('height', self.graphHeight);
      svg.selectAll('.loading-text').data([(0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Loading metrics...')]).enter().append('text', 'rect').attr('class', 'loading-text').text(function (d) {
        return d;
      }).attr('text-anchor', 'middle').attr('dy', self.graphHeight / 2).attr('dx', self.graphWidth / 2);
    }
  }, {
    key: "redrawGraph",
    value: function redrawGraph() {
      var self = this; // Wait for data to appear
      ...
      var mainMargin = {
        ...
        right: 70,
        left: 70,
        bottom: self.graphHeight - subTop + 40
      };
      var subMargin = {
        top: subTop,
        right: 70,
      ...
      var subHeight = self.graphHeight - subMargin.top - subMargin.bottom - 50; // Scales

      var percentageYScale = d3__WEBPACK_IMPORTED_MODULE_0__.scaleLinear().range([mainHeight, 0]);
      var queryYScale = d3__WEBPACK_IMPORTED_MODULE_0__.scaleLinear().range([mainHeight, 0]);
      var mainXScale = d3__WEBPACK_IMPORTED_MODULE_0__.scaleTime().range([0, width]);
      var subPercentageYScale = d3__WEBPACK_IMPORTED_MODULE_0__.scaleLinear().range([subHeight, 0]);
      var subQueryYScale = d3__WEBPACK_IMPORTED_MODULE_0__.scaleLinear().range([subHeight, 0]);
      var subXScale = d3__WEBPACK_IMPORTED_MODULE_0__.scaleTime().range([0, width]); // Axes

      var mainXAxis = d3__WEBPACK_IMPORTED_MODULE_0__.axisBottom(mainXScale).tickPadding(7);
      var subXAxis = d3__WEBPACK_IMPORTED_MODULE_0__.axisBottom(subXScale).tickPadding(7).tickSize(0);
      var queryYAxis = d3__WEBPACK_IMPORTED_MODULE_0__.axisLeft(queryYScale).tickPadding(7);
      var percentageYAxis = d3__WEBPACK_IMPORTED_MODULE_0__.axisRight(percentageYScale).tickPadding(7).tickFormat(function (y) {
        return y + '%';
      ...
      d3__WEBPACK_IMPORTED_MODULE_0__.select(self.graphElement).select('svg').remove(); // Draw the graphs

      var svg = d3__WEBPACK_IMPORTED_MODULE_0__.select(self.graphElement).append('svg').attr('width', self.graphWidth).attr('height', self.graphHeight); // Clipping path

      svg.append('defs').append('clipPath').attr('id', 'clip').append('rect').attr('width', width).attr('height', mainHeight); // Containers for the graphs and legend

      var mainGroup = svg.append('g').attr('class', 'main-group').attr('transform', 'translate(' + mainMargin.left + ',' + mainMargin.top + ')');
      var subGroup = svg.append('g').attr('class', 'sub-group').attr('transform', 'translate(' + subMargin.left + ',' + subMargin.top + ')');
      var legendGroup = svg.append('g').attr('class', 'legend-group').attr('transform', 'translate(' + legendMargin.left + ',' + legendMargin.top + ')'); // Draw the query and resource graphs

      var createLineGraph = function createLineGraph(options) {
        var line;
        var _enabled = options.enabled;

        if (options.area) {
          line = d3__WEBPACK_IMPORTED_MODULE_0__.area().curve(d3__WEBPACK_IMPORTED_MODULE_0__.curveStep).x(function (d) {
            return mainXScale(d[0]);
          }).y0(mainHeight).y1(options.y);
        } else {
          line = d3__WEBPACK_IMPORTED_MODULE_0__.line().curve(d3__WEBPACK_IMPORTED_MODULE_0__.curveMonotoneX).x(function (d) {
            return mainXScale(d[0]);
          }).y(options.y);
        }

        var path = mainGroup.append('path').datum(self.data).attr('stroke', function () {
          return options.color;
        }).attr('stroke-width', options.area ? 0 : 2).style('opacity', _enabled ? 1 : 0).attr('fill', options.area ? options.color : 'none').attr('clip-path', 'url(#clip)').classed('line line-' + options.id, true).attr('d', line);
        var subRefresh;
        ...
        if (options.subLine) {
          ...
          if (options.area) {
            subLine = d3__WEBPACK_IMPORTED_MODULE_0__.area().curve(d3__WEBPACK_IMPORTED_MODULE_0__.curveStep).x(function (d) {
              return subXScale(d[0]);
            }).y0(subHeight).y1(options.subY);
          } else {
            subLine = d3__WEBPACK_IMPORTED_MODULE_0__.line().curve(d3__WEBPACK_IMPORTED_MODULE_0__.curveMonotoneX).x(function (d) {
              return subXScale(d[0]);
            }).y(options.subY);
          }

          var subPath = subGroup.append('path').datum(self.data).attr('stroke', function () {
            return options.subLineColor || options.color;
          }).style('opacity', _enabled ? 1 : 0).attr('fill', options.area ? options.subLineColor || options.color : 'none').attr('clip-path', 'url(#clip)').classed('line line-' + options.id, true).attr('d', subLine);

          subRefresh = function subRefresh() {
        ...
        return {
          ...
          toggle: function toggle() {
            _enabled = !_enabled;
            (0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_5__.setInLocalStorage)('warehouses.' + options.id + 'GraphEnabled', _enabled);
            mainGroup.select('.highlight-point-' + options.id).style('display', _enabled ? null : 'none');
            mainGroup.select('.line-' + options.id).transition().style('opacity', _enabled ? 1 : 0);
            subGroup.select('.line-' + options.id).transition().style('opacity', _enabled ? 1 : 0);

            if (stackedGraph) {
              stackedGraph.enabled = _enabled;
              mainGroup.select('.highlight-point-' + stackedGraph.id).style('display', _enabled ? null : 'none');
              mainGroup.select('.line-' + stackedGraph.id).transition().style('opacity', _enabled ? 1 : 0);
              subGroup.select('.line-' + stackedGraph.id).transition().style('opacity', _enabled ? 1 : 0);
            }
          },
          highlightPoint: function highlightPoint(dataPoint) {
            if (!options.disableHighlight) {
              mainGroup.select('.highlight-point-' + options.id).remove();
              mainGroup.insert('circle', '.overlay').attr('class', 'highlight-point highlight-point-' + options.id).style('display', _enabled ? null : 'none').attr('stroke', '#FFF').attr('stroke-width', 2).attr('fill', function () {
                return options.color;
              }).attr('r', 4).attr('transform', 'translate(' + mainXScale(dataPoint[0]) + ',' + options.y(dataPoint) + ')');
            }
          }
        };
      };

      var graphs = [createLineGraph({
        id: 'queries',
        label: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Queries'),
        enabled: (0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_5__.getFromLocalStorage)('warehouses.queriesGraphEnabled', true),
        color: '#A9DBF1',
        subLineColor: '#DCDCDC',
        area: true,
        subLine: true,
        tooltip: function tooltip(d) {
          return d[4] + (d[5] ? ' (' + d[5] + ' ' + (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('queued') : '');
        },
        y: function y(d) {
          return queryYScale(d[4]);
        },
        subY: function subY(d) {
          return subQueryYScale(d[4]);
        },
        stackedGraph: function stackedGraph() {
        ...
        id: 'cpu',
        enabled: (0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_5__.getFromLocalStorage)('warehouses.cpuGraphEnabled', false),
        label: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('CPU'),
        color: '#654C94',
        subLine: true,
        tooltip: function tooltip(d) {
          return d[1] + '%';
        ...
        id: 'memory',
        enabled: (0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_5__.getFromLocalStorage)('warehouses.memoryGraphEnabled', false),
        label: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Memory'),
        color: '#83C1B9',
        subLine: true,
        tooltip: function tooltip(d) {
          return d[2] + '%';
        ...
        id: 'io',
        enabled: (0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_5__.getFromLocalStorage)('warehouses.ioGraphEnabled', false),
        label: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('IO'),
        color: '#D4965E',
        subLine: true,
        tooltip: function tooltip(d) {
          return d[3] + '%';
      ...
      mainGroup.append('g').attr('class', 'main-axis main-axis-x').attr('transform', 'translate(0,' + mainHeight + ')').call(mainXAxis);
      mainGroup.append('g').attr('class', 'main-axis main-axis-y main-axis-query-count').call(queryYAxis);
      mainGroup.append('g').attr('class', 'main-axis main-axis-y main-axis-percentage').attr('transform', 'translate(' + width + ' ,0)').call(percentageYAxis);
      subGroup.append('g').attr('class', 'sub-axis sub-axis-x').attr('transform', 'translate(0,' + subHeight + ')').call(subXAxis);
      mainGroup.append('text').attr('class', 'y-label y-label-queries').attr('transform', 'rotate(-90)').attr('x', -mainHeight / 2).attr('y', -45).attr('dy', '1em').style('text-anchor', 'middle');
      mainGroup.append('text').attr('class', 'y-label y-label-resources').attr('transform', 'rotate(90)').attr('x', mainHeight / 2).attr('y', -width - 55).attr('dy', '1em').style('text-anchor', 'middle');

      var updateAxesLabels = function updateAxesLabels() {
        var queriesLabel = '';
        var resourcesLabel = '';
      ...
      updateAxesLabels(); // Add brush

      var brushed = function brushed() {
        var s = d3__WEBPACK_IMPORTED_MODULE_0__.event.selection || subXScale.range();
      ...
      var brush = d3__WEBPACK_IMPORTED_MODULE_0__.brushX().extent([[0, 0], [width, subHeight]]).on('start brush end', brushed);
      var brushG = subGroup.append('g').attr('class', 'brush').call(brush);
      var handle = brushG.selectAll('.handle--custom').data([{
        type: 'w'
      }, {
        type: 'e'
      }]).enter().append('circle').classed('handle--custom', true).attr('cursor', 'ew-resize').attr('fill', '#FFF').attr('r', 8).attr('stroke', '#787878').attr('stroke-width', 7);
      brushG.call(brush.move, [mainXScale(Math.max(self.data[self.data.length - 1][0] - self.selectedGranularity().initialWindow, self.data[0][0])), mainXScale(self.data[self.data.length - 1][0])]); // Mouse hover overlay

      var dateBisector = d3__WEBPACK_IMPORTED_MODULE_0__.bisector(function (d) {
        return d[0];
      }).left;

      var pointFocus = function pointFocus(mouseCoord, focusX) {
        var x = focusX;
        ...
        var generateTooltipHtml = function generateTooltipHtml(dataPoint) {
        ...
        d3__WEBPACK_IMPORTED_MODULE_0__.select(self.graphElement).select('.performance-tooltip').html(generateTooltipHtml(closest)).style('left', lastMouseCoord[0] + mainMargin.left + 15 + 'px').style('top', lastMouseCoord[1] + mainMargin.top + 'px');
      };

      var lastMouseCoord = [0, 0];
      var lastFocusX = 0;
      mainGroup.append('rect').attr('class', 'overlay').attr('fill-opacity', '0').attr('fill', 'white').attr('width', width).attr('height', mainHeight).on('mouseout', function () {
        mainGroup.selectAll('.highlight-point').remove();
        d3__WEBPACK_IMPORTED_MODULE_0__.select(self.graphElement).selectAll('.performance-tooltip').remove();
      }).on('mouseover', function () {
        d3__WEBPACK_IMPORTED_MODULE_0__.select(self.graphElement).append('div').attr('class', 'performance-tooltip');
      }).on('mousemove', function () {
        lastMouseCoord = d3__WEBPACK_IMPORTED_MODULE_0__.mouse(this);
        lastFocusX = mainXScale.invert(lastMouseCoord[0]);
        pointFocus(lastMouseCoord, lastFocusX);
      }); // Add Legend

      var legendSerie = legendGroup.selectAll('.legend-serie').data(graphs).enter().append('g').attr('class', 'legend-serie').on('click', function (d) {
        d.toggle();
        d3__WEBPACK_IMPORTED_MODULE_0__.select(this).select('rect').transition().attr('fill', function (d) {
          return d.enabled() ? d.color : '#FFF';
        });
        d3__WEBPACK_IMPORTED_MODULE_0__.select(this).select('path').transition().attr('opacity', function (d) {
          return d.enabled() ? 1 : 0;
        });
        updateAxesLabels();
      });
      legendSerie.append('rect').attr('class', 'legend-radio').attr('fill', function (d) {
        return d.enabled() ? d.color : '#FFF';
      }).attr('stroke', function (d) {
        return d.color;
      }).attr('stroke-width', 2).attr('rx', 2).attr('ry', 2).attr('width', 12).attr('height', 12).attr('transform', 'translate(-8, -6)');
      legendSerie.append('path').attr('d', 'M-6,-1, -2,3, 2,-4').attr('fill', 'none').attr('stroke', function (d, j) {
        return j === 0 || j === 2 ? '#000' : '#FFF';
      }).transition().attr('opacity', function (d) {
        return d.enabled() ? 1 : 0;
      }).attr('stroke-width', 2);
      legendSerie.append('text', 'rect').text(function (d) {
        return d.label;
      }).attr('text-anchor', 'start').attr('dy', '.32em').attr('dx', '8');
      legendSerie.append('line');
      var knownLengths = [];
      legendSerie.attr('transform', function (d, j) {
        knownLengths[j] = d3__WEBPACK_IMPORTED_MODULE_0__.select(this).select('text').node().getComputedTextLength() + 28;
        var x = 5;
    ...
    value: function loadData() {
      var self = this;
      return _api_apiHelper__WEBPACK_IMPORTED_MODULE_3__.default.fetchResourceStats({
...
_componentUtils__WEBPACK_IMPORTED_MODULE_2__.default.registerComponent(NAME, PerformanceGraph, TEMPLATE);
...
var PollingCatalogEntriesList = /*#__PURE__*/function () {
  ...
  _createClass(PollingCatalogEntriesList, [{
  ...
  return PollingCatalogEntriesList;
}();
...
var NAME = 'quick-query-action'; // prettier-ignore
...
var QuickQueryAction = /*#__PURE__*/function (_DisposableComponent) {
  ...
  var _super = _createSuper(QuickQueryAction);
...
var TEMPLATE = "\n  <script type=\"text/html\" id=\"sentry-privileges-component-role\">\n    <div class=\"acl-block-title\">\n      <i class=\"fa fa-cube muted\"></i> <a class=\"pointer\" data-bind=\"click: function(){  $parents[0].showRole($data); }\"><span data-bind=\"text: name\"></span></a>\n    </div>\n    <div data-bind=\"template: { name: 'sentry-privileges-component-privilege', foreach: privilegesForView }\"></div>\n    <div class=\"acl-block acl-actions\">\n      <span class=\"pointer\" data-bind=\"visible: privilegesForViewTo() < privileges().length, click: function(){ privilegesForViewTo(privilegesForViewTo() + 50) }\" title=\"".concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Show 50 more...'), "\"><i class=\"fa fa-ellipsis-h\"></i></span>\n      <span class=\"pointer\" data-bind=\"click: addPrivilege, visible: $parents[0].isSentryAdmin && !$parents[0].readOnly\" title=\"").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Add privilege'), "\"><i class=\"fa fa-plus\"></i></span>\n      <span class=\"pointer\" data-bind=\"click: function() { $parents[0].listSentryPrivilegesByAuthorizable() }, visible: privilegesChanged().length > 0\" title=\"").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Undo'), "\"> &nbsp; <i class=\"fa fa-undo\"></i></span>\n      <span class=\"pointer\" data-bind=\"click: function() { $parents[0].deletePrivilegeModal($data) }, visible: privilegesChanged().length > 0\" title=\"").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Save'), "\"> &nbsp; <i class=\"fa fa-save\"></i></span>\n    </div>\n  </script>\n\n  <script type=\"text/html\" id=\"sentry-privileges-component-privilege\">\n    <div data-bind=\"visible: status() != 'deleted' && status() != 'alreadydeleted'\" class=\"acl-block acl-block-airy\">\n      <!-- ko if: editing -->\n      <div class=\"pull-right privilege-actions\" data-bind=\"visible: (grantOption() || $parents[1].isSentryAdmin) && !$parents[1].readOnly\">\n        <a class=\"pointer\" style=\"margin-right: 4px\" data-bind=\"click: function() { if (editing()) { editing(false); }}\"><i class=\"fa fa-eye\"></i></a>\n        <a class=\"pointer\" style=\"margin-right: 4px\" data-bind=\"click: remove\"><i class=\"fa fa-times\"></i></a>\n      </div>\n    \n      <div class=\"inline-block\" style=\"vertical-align: middle\">\n        <a class=\"pointer\" style=\"padding-top: 4px\" data-bind=\"click: function(){ privilegeType('db'); action($parents[1].availableActions(privilegeScope())[0]) }\">\n          <i class=\"fa fa-fw fa-1halfx muted\" data-bind=\"css: {'fa-circle-o': privilegeType() != 'db' , 'fa-check-circle-o': privilegeType() == 'db'}\"></i>\n        </a>\n      </div>\n      <input type=\"text\" data-bind=\"hiveChooser: $data.path, enable: privilegeType() == 'db', apiHelperUser: '").concat(window.LOGGED_USERNAME, "', apiHelperType: 'hive'\" placeholder=\"dbName.tableName <CTRL+SPACE>\">\n    \n      <div class=\"inline-block\" style=\"vertical-align: middle\">\n        <a class=\"pointer\" style=\"padding-top: 4px\" data-bind=\"click: function(){ privilegeType('uri'); action('ALL'); }\">\n          <i class=\"fa fa-fw fa-1halfx muted\" data-bind=\"css: {'fa-circle-o': privilegeType() != 'uri' , 'fa-check-circle-o': privilegeType() == 'uri'}\"></i>\n        </a>\n      </div>\n      <input type=\"text\" data-bind=\"filechooser: $data.URI, enable: privilegeType() == 'uri', valueUpdate: 'afterkeydown'\" placeholder=\"URI\">\n    \n      <select data-bind=\"options: $parents[1].availableActions(privilegeScope()), value: $data.action, enable: (privilegeType() == 'db')\" style=\"width: 100px; margin-bottom: 0\"></select>\n    \n      <div class=\"margin-top-10\">\n        <label class=\"checkbox pull-left\"><input type=\"checkbox\" data-bind=\"checked: grantOption\"> ").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('With grant'), "</label>\n        <div class=\"inline-block margin-left-10\" style=\"margin-top: 6px\">\n          <a class=\"pointer showAdvanced\" data-bind=\"click: function(){ showAdvanced(true); }, visible: !showAdvanced()\"><i class=\"fa fa-cog\"></i> ").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Show advanced'), "</a>\n          <a class=\"pointer showAdvanced\" data-bind=\"click: function(){ showAdvanced(false); }, visible: showAdvanced()\"><i class=\"fa fa-cog\"></i> ").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Hide advanced'), "</a>\n        </div>\n        <div class=\"clearfix\"></div>\n      </div>\n    \n      <div class=\"acl-block-section\" data-bind=\"visible: showAdvanced\" style=\"margin-top: 0\">\n        ").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Server'), " <input type=\"text\" data-bind=\"value: serverName\" placeholder=\"serverName\" style=\"margin-left: 6px\">\n      </div>\n      <!-- /ko -->\n  \n      <!-- ko ifnot: editing -->\n      <div class=\"pull-right privilege-actions\" data-bind=\"visible: (grantOption() || $parents[1].isSentryAdmin) && !$parents[1].readOnly\">\n        <a title=\"").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Edit this privilege'), "\" class=\"pointer\" style=\"margin-right: 4px\" data-bind=\"visible: $parents[1].isSentryAdmin, click: function() { if (! editing()) { editing(true); }}\"><i class=\"fa fa-pencil\"></i></a>\n        <a title=\"").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Delete this privilege'), "\" class=\"pointer\" style=\"margin-right: 4px\" data-bind=\"visible: $parents[1].isSentryAdmin, click: remove\"><i class=\"fa fa-times\"></i></a>\n      </div>\n  \n      <span class=\"muted\" data-bind=\"text: privilegeScope, attr: {title: moment(timestamp()).fromNow()}\"></span>\n      <!-- ko if: grantOption -->\n        <i class=\"fa fa-unlock muted\" title=\"").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('With grant option'), "\"></i>\n      <!-- /ko -->\n      <span data-bind=\"visible: metastorePath() != '' && privilegeType() == 'db'\">\n        <a data-bind=\"hueLink: metastorePath()\" class=\"muted\" style=\"margin-left: 4px\" title=\"").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Open in Table Browser...'), "\"><i class=\"fa fa-external-link\"></i></a>\n      </span>\n      <br/>\n  \n      server=<span data-bind=\"text: serverName\"></span>\n  \n      <!-- ko if: privilegeType() == 'db' -->\n      <span data-bind=\"visible: dbName\">\n        <i class=\"fa fa-long-arrow-right\"></i> db=<a class=\"pointer\" data-bind=\"click: function(){ $parents[1].linkToBrowse(dbName()) }\" title=\"").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Browse db privileges'), "\"><span data-bind=\"text: dbName\"></span></a>\n      </span>\n      <span data-bind=\"visible: tableName\">\n        <i class=\"fa fa-long-arrow-right\"></i> table=<a class=\"pointer\" data-bind=\"click: function(){ $parents[1].linkToBrowse(dbName() + '.' + tableName()) }\" title=\"").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Browse table privileges'), "\"><span data-bind=\"text: tableName\"></span></a>\n      </span>\n      <span data-bind=\"visible: columnName\">\n        <i class=\"fa fa-long-arrow-right\"></i> column=<a class=\"pointer\" data-bind=\"click: function(){ $parents[1].linkToBrowse(dbName() + '.' + tableName() + '.' + columnName()) }\" title=\"").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Browse column privileges'), "\"><span data-bind=\"text: columnName\"></span></a>\n      </span>\n      <!-- /ko -->\n  \n      <!-- ko if: privilegeType() == 'uri' -->\n      <i class=\"fa fa-long-arrow-right\"></i> <i class=\"fa fa-file-o\"></i> <i class=\"fa fa-long-arrow-right\"></i> <a data-bind=\"hueLink: '/filebrowser/view=/' + URI().split('/')[3]\"><span data-bind=\"text: URI\"></span></a>\n      <!-- /ko -->\n  \n      <i class=\"fa fa-long-arrow-right\"></i> action=<span data-bind=\"text: action\"></span>\n      <!-- /ko -->\n    </div>\n  </script>\n\n  <!-- ko hueSpinner: { spin: isLoadingPrivileges, inline: true } --><!-- /ko -->\n  <!-- ko if: roles().length -->\n  <div data-bind=\"template: { name: 'sentry-privileges-component-role', foreach: roles }\"></div>\n  <!-- /ko -->\n  <!-- ko ifnot: roles().length -->\n  <em>").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('No privileges found for the selected object.'), "</em>\n  <!-- /ko -->\n  \n  <div id=\"sentryPrivilegesComponentDeletePrivilegeModal\" class=\"modal hide fade in\" role=\"dialog\">\n    <div class=\"modal-header\">\n      <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Close'), "\"><span aria-hidden=\"true\">&times;</span></button>\n      <h2 class=\"modal-title\">").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Confirm the deletion?'), "</h2>\n    </div>\n    <div class=\"modal-body\">\n      ").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Sentry will recursively delete the SERVER or DATABASE privileges you marked for deletion.'), "\n    </div>\n    <div class=\"modal-footer\">\n      <button class=\"btn\" data-dismiss=\"modal\" aria-hidden=\"true\">").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Cancel'), "</button>\n      <button data-loading-text=\"").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Deleting...'), "\" class=\"btn btn-danger\" data-bind=\"click: function() { roleToUpdate().savePrivileges(roleToUpdate()); }\">").concat((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Yes, delete'), "</button>\n    </div>\n  </div>\n");

var Privilege = function Privilege(vm, privilege) {
...
var Role = function Role(vm, role) {
  ...
  self.saveGroups = function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.jHueNotify').remove();
    jquery__WEBPACK_IMPORTED_MODULE_0___default().post('/security/api/hive/update_role_groups', {
      ...
      if (data.status === 0) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).trigger('error', data.message);
      }
    }).fail(function (xhr) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).trigger('error', xhr.responseText);
    });
  };
  ...
  self.create = function () {
    ...
    if (self.isValid()) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default().post('/security/api/hive/create_role', {
        ...
        if (data.status === 0) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).trigger('info', data.message);
...
var SentryPrivilegesViewModel = function SentryPrivilegesViewModel(params) {
  ...
  self.linkToBrowse = function (path) {// TODO: implement smart linking
  };
...
var SessionPanel = /*#__PURE__*/function () {
  ...
  _createClass(SessionPanel, [{
    key: "showSessions",
    value: function () {
      var _showSessions = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(typeFilter) {
        var sessions;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
    ...
    key: "restartSession",
    value: function () {
      var _restartSession = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(editableSession) {
        var session;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
    ...
    key: "closeSession",
    value: function () {
      var _closeSession = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(editableSession) {
        var session;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
...
var SHOWN_EVENT = 'share.gist.modal.shown'; // prettier-ignore
...
var ShareGistModal = /*#__PURE__*/function (_DisposableComponent) {
  ...
  var _super = _createSuper(ShareGistModal);
  ...
  _createClass(ShareGistModal, [{
    key: "postMessage",
    value: function () {
      var _postMessage = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
...
var SqlColumnsTable = function SqlColumnsTable(params) {
...
var normalizedColors = _utils_hueColors__WEBPACK_IMPORTED_MODULE_1__.default.getNormalizedColors(); // TODO: Autocomplete colors should be global
...
var SolrFormulaSuggestions = /*#__PURE__*/function () {
  ...
  _createClass(SolrFormulaSuggestions, [{
    key: "update",
...
var SolrFormulaAutocompleter = /*#__PURE__*/function () {
  ...
  _createClass(SolrFormulaAutocompleter, [{
    key: "autocomplete",
    value: function () {
      var _autocomplete = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var _this = this;
...
var normalizedColors = _utils_hueColors__WEBPACK_IMPORTED_MODULE_3__.default.getNormalizedColors(); // TODO: Autocomplete colors should be global
...
var SolrQuerySuggestions = /*#__PURE__*/function () {
  ...
  _createClass(SolrQuerySuggestions, [{
    key: "update",
    value: function update(parseResult) {
      var self = this;
      self.lastNonSampleSuggestions = [];
...
var SolrQueryAutocompleter = /*#__PURE__*/function () {
  ...
  _createClass(SolrQueryAutocompleter, [{
    key: "autocomplete",
    value: function () {
      var _autocomplete = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var _this = this;
...
//# sourceMappingURL=/static/desktop/js/bundles/hue/hue-8c9fb242-bundle-3c690b33b5f47cc0d68b.js.map