...
var EditorViewModel = /*#__PURE__*/function () {
  function EditorViewModel(editorId, notebooks, options, CoordinatorEditorViewModel, RunningCoordinatorModel) {
    var _this = this;
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.publish(config_events__WEBPACK_IMPORTED_MODULE_7__.GET_KNOWN_CONFIG_TOPIC, this.config);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.subscribe(config_events__WEBPACK_IMPORTED_MODULE_7__.CONFIG_REFRESHED_TOPIC, this.config);
    ...
    this.editorTitle = knockout__WEBPACK_IMPORTED_MODULE_1__.pureComputed(function () {
      return window.HPLSQL && _this.activeConnector() && _this.activeConnector().displayName === 'Hive' ? 'Hive HPL/SQL' : _this.activeConnector() && _this.activeConnector().displayName;
    });
    ...
    this.activeConnector.subscribe(function (connector) {
      if (connector) {
        if ((0,utils_url_getParameter__WEBPACK_IMPORTED_MODULE_14__.default)('type') !== connector.id) {
          (0,utils_url_changeURLParameter__WEBPACK_IMPORTED_MODULE_13__.default)('type', connector.id);
        }
    ...
    this.topExpanded.subscribe(function (newVal) {
      if (newVal) {
        ...
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.publish('left.assist.hide', true);
      } else {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.publish('both.assists.revert', true);
      }
    });
    ...
    this.isLeftPanelVisible = knockout__WEBPACK_IMPORTED_MODULE_1__.observable((0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_10__.getFromLocalStorage)('assist.assist_panel_visible', true));
    ...
    this.isRightPanelVisible = knockout__WEBPACK_IMPORTED_MODULE_1__.observable((0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_10__.getFromLocalStorage)('assist.right_assist_panel_visible', true));
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.subscribe('assist.highlight.risk.suggestions', function () {
      if (_this.isRightPanelAvailable() && !_this.isRightPanelVisible()) {
        _this.isRightPanelVisible(true);
      }
    });
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.subscribe(_events__WEBPACK_IMPORTED_MODULE_4__.GET_ACTIVE_SNIPPET_CONNECTOR_EVENT, function (callback) {
      _this.withActiveSnippet(function (activeSnippet) {
        callback(activeSnippet.connector());
      });
    }, this.huePubSubId);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.subscribe('save.snippet.to.file', function () {
      _this.withActiveSnippet(function (activeSnippet) {
        var data = {
        ...
        var options = {
          successCallback: function successCallback(result) {
            if (result && result.exists) {
              jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).trigger('info', result.path + ' saved successfully.');
            }
          }
        };
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.subscribe('sql.context.pin', function (contextData) {
      _this.withActiveSnippet(function (activeSnippet) {
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.subscribe('assist.database.set', function (entry) {
      _this.withActiveSnippet(function (activeSnippet) {
        activeSnippet.handleAssistSelection(entry);
      });
    }, this.huePubSubId);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.subscribe('assist.database.selected', function (entry) {
      _this.withActiveSnippet(function (activeSnippet) {
        activeSnippet.handleAssistSelection(entry);
      });
    }, this.huePubSubId);
  ...
  _createClass(EditorViewModel, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return this.openNotebook(this.editorId);
              ...
              case 5:
                if (!((0,utils_url_getParameter__WEBPACK_IMPORTED_MODULE_14__.default)('gist') !== '' || (0,utils_url_getParameter__WEBPACK_IMPORTED_MODULE_14__.default)('type') !== '')) {
                  _context.next = 10;
                  break;
                }

                _context.next = 8;
                return this.newNotebook((0,utils_url_getParameter__WEBPACK_IMPORTED_MODULE_14__.default)('type'));
              ...
              case 10:
                if (!((0,utils_url_getParameter__WEBPACK_IMPORTED_MODULE_14__.default)('editor') !== '')) {
                  _context.next = 15;
                  break;
                }

                _context.next = 13;
                return this.openNotebook((0,utils_url_getParameter__WEBPACK_IMPORTED_MODULE_14__.default)('editor'));
    ...
    value: function loadNotebook(notebookRaw, queryTab) {
      ...
      if (notebook.snippets().length > 0) {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.publish('detach.scrolls', notebook.snippets()[0]);
      ...
      utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.publish('check.job.browser');
      utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.publish('recalculate.name.description.width');
    }
  }, {
    key: "newNotebook",
    value: function () {
      var _newNotebook = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(connectorId, callback, queryTab, blank) {
        var _this2 = this;
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (!connector) {
                  ...
                  utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.publish(_events__WEBPACK_IMPORTED_MODULE_4__.ACTIVE_SNIPPET_CONNECTOR_CHANGED_EVENT, connector);
                }
                ...
                return _context2.abrupt("return", new Promise(function (resolve, reject) {
                  jquery__WEBPACK_IMPORTED_MODULE_0___default().post('/notebook/api/create_notebook', {
                    ...
                    gist: _this2.isNotificationManager() ? undefined : (0,utils_url_getParameter__WEBPACK_IMPORTED_MODULE_14__.default)('gist'),
                    ...
                    if (_this2.editorMode() && !_this2.isNotificationManager()) {
                      ...
                      utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.publish('detach.scrolls', _this2.selectedNotebook().snippets()[0]);
                    }
    ...
    key: "openNotebook",
    value: function () {
      var _openNotebook = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(uuid, queryTab, skipUrlChange, callback) {
    ...
    value: function notifyDialectChange(dialect) {
      if (dialect && this.lastNotifiedDialect !== dialect) {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.publish(_events__WEBPACK_IMPORTED_MODULE_4__.ACTIVE_SNIPPET_CONNECTOR_CHANGED_EVENT, this.activeConnector());
    ...
    value: function prepareShareModal() {
      ...
      if (selectedNotebookUuid) {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.publish('doc.show.share.modal', selectedNotebookUuid);
      }
    }
  }, {
    key: "saveAsNotebook",
    value: function saveAsNotebook() {
      ...
      this.selectedNotebook().uuid((0,utils_string_UUID__WEBPACK_IMPORTED_MODULE_11__.default)());
    ...
    key: "saveNotebook",
    value: function () {
      var _saveNotebook = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    ...
    value: function showSessionPanel() {
      this.withActiveSnippet(function (snippet) {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.publish('session.panel.show', snippet.dialect());
      }, function () {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_9__.default.publish('session.panel.show');
      });
    }
  }, {
...
/* harmony import */ var sql_workers_hueWorkerHandler__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! sql/workers/hueWorkerHandler */ "./desktop/core/src/desktop/js/sql/workers/hueWorkerHandler.ts");
...
/* harmony import */ var utils_screen_scrollbarWidth__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! utils/screen/scrollbarWidth */ "./desktop/core/src/desktop/js/utils/screen/scrollbarWidth.ts");
/* harmony import */ var utils_timing_waitForRendered__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! utils/timing/waitForRendered */ "./desktop/core/src/desktop/js/utils/timing/waitForRendered.ts");
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./events */ "./desktop/core/src/desktop/js/apps/editor/events.js");
/* harmony import */ var _EditorViewModel__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./EditorViewModel */ "./desktop/core/src/desktop/js/apps/editor/EditorViewModel.js");
/* harmony import */ var _snippet__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./snippet */ "./desktop/core/src/desktop/js/apps/editor/snippet.js");
/* harmony import */ var _ko_components_assist_events__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../ko/components/assist/events */ "./desktop/core/src/desktop/js/ko/components/assist/events.js");
// Licensed to Cloudera, Inc. under one
// or more contributor license agreements.  See the NOTICE file
// distributed with this work for additional information
// regarding copyright ownership.  Cloudera, Inc. licenses this file
...
utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('app.dom.loaded', function (app) {
  if (app === 'editor') {
    window.MAIN_SCROLLABLE = '.page-content';
    var isLeftNavOpen = false;
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('left.nav.open.toggle', function (val) {
      isLeftNavOpen = val;
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('split.panel.resized', function () {
      utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish('recalculate.name.description.width');
    }, HUE_PUB_SUB_EDITOR_ID);
    ...
    var hideHoverMsg = function hideHoverMsg(vm) {
      if (vm.editorMode()) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()(window.EDITOR_BINDABLE_ELEMENT).find('.hoverText').html((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_9__.default)('Drop a SQL file here'));
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()(window.EDITOR_BINDABLE_ELEMENT).find('.hoverText').html((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_9__.default)('Drop iPython/Zeppelin notebooks here'));
      }
    ...
    var replaceAce = function replaceAce(content) {
      ...
      utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish(_events__WEBPACK_IMPORTED_MODULE_12__.REDRAW_FIXED_HEADERS_EVENT);
    };

    window.replaceAce = replaceAce; // Drag and drop iPython / Zeppelin notebooks
    ...
    if (window.EDITOR_ENABLE_QUERY_SCHEDULING) {
      viewModel = new _EditorViewModel__WEBPACK_IMPORTED_MODULE_13__.default(window.EDITOR_ID, window.NOTEBOOKS_JSON, window.EDITOR_VIEW_MODEL_OPTIONS, window.CoordinatorEditorViewModel, window.RunningCoordinatorModel);
    } else {
      viewModel = new _EditorViewModel__WEBPACK_IMPORTED_MODULE_13__.default(window.EDITOR_ID, window.NOTEBOOKS_JSON, window.EDITOR_VIEW_MODEL_OPTIONS);
    }
    ...
    viewModel.init();
    (0,sql_workers_hueWorkerHandler__WEBPACK_IMPORTED_MODULE_7__.registerHueWorkers)();
    viewModel.selectedNotebook.subscribe(function (newVal) {
      utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish('selected.notebook.changed', newVal);
    });
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe(_events__WEBPACK_IMPORTED_MODULE_12__.IGNORE_NEXT_UNLOAD_EVENT, function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.preview-sample').css('right', 10 + (0,utils_screen_scrollbarWidth__WEBPACK_IMPORTED_MODULE_10__.default)() + 'px');
    ...
    var initKeydownBindings = function initKeydownBindings() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).bind('keydown.editor', 'ctrl+shift+p alt+shift+p meta+shift+p', function (e) {
        e.preventDefault();
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish('editor.presentation.toggle');
        return false;
      });
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).bind('keyup', function (e) {
      ...
      if (e.keyCode === 191 && !e.shiftKey && !jquery__WEBPACK_IMPORTED_MODULE_1___default()(e.target).is('input') && !jquery__WEBPACK_IMPORTED_MODULE_1___default()(e.target).is('textarea')) {
        if (viewModel.editorMode() && viewModel.selectedNotebook().snippets()[0].currentQueryTab() === 'queryResults') {
          e.preventDefault();
          utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish(_events__WEBPACK_IMPORTED_MODULE_12__.SHOW_GRID_SEARCH_EVENT);
          return false;
        }
      }
    });
    ...
    var getDraggableOptions = function getDraggableOptions(minY) {
      return {
        ...
        start: function start(e, ui) {
          ...
          utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish(_events__WEBPACK_IMPORTED_MODULE_12__.HIDE_FIXED_HEADERS_EVENT);
        },
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('split.draggable.position', function () {
      window.clearTimeout(splitDraggableTimeout);
      splitDraggableTimeout = window.setTimeout(function () {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish(_events__WEBPACK_IMPORTED_MODULE_12__.REDRAW_FIXED_HEADERS_EVENT);
      }, 200);
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('app.gained.focus', function (app) {
      if (app === 'editor') {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish(_events__WEBPACK_IMPORTED_MODULE_12__.REDRAW_FIXED_HEADERS_EVENT);
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish('hue.scrollleft.show');
        viewModel.notifyDialectChange(viewModel.editorType(), viewModel.getSnippetViewSettings(viewModel.editorType()).sqlDialect);
      }
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('current.query.tab.switched', function (tab) {
      if (tab !== 'queryResults') {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.hue-datatable-search').hide();
      }
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('editor.create.new', newKeyHandler, HUE_PUB_SUB_EDITOR_ID);

    if (viewModel.isSqlAnalyzerEnabled()) {
      if (window.SQL_ANALYZER_AUTO_UPLOAD_QUERIES) {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('editor.upload.query', function (query_id) {
          viewModel.selectedNotebook().snippets()[0].uploadQuery(query_id);
        }, HUE_PUB_SUB_EDITOR_ID);
      }

      if (window.SQL_ANALYZER_AUTO_UPLOAD_DDL) {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('editor.upload.table.stats', function (options) {
          viewModel.selectedNotebook().snippets()[0].uploadTableStats(options);
        }, HUE_PUB_SUB_EDITOR_ID);
      }

      if (window.SQL_ANALYZER_QUERY_HISTORY_UPLOAD_LIMIT !== 0) {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('editor.upload.history', function () {
          viewModel.selectedNotebook().snippets()[0].uploadQueryHistory(5);
        }, HUE_PUB_SUB_EDITOR_ID);
      }
    }

    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('get.selected.notebook', function () {
      utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish('set.selected.notebook', viewModel.selectedNotebook());
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe(_ko_components_assist_events__WEBPACK_IMPORTED_MODULE_15__.SHOW_LEFT_ASSIST_EVENT, function () {
      if (!viewModel.isLeftPanelVisible() && viewModel.assistAvailable()) {
        viewModel.isLeftPanelVisible(true);
      }
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('assist.set.manual.visibility', function () {
      wasLeftPanelVisible = viewModel.isLeftPanelVisible();
      wasRightPanelVisible = viewModel.isRightPanelVisible();
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('editor.presentation.operate.toggle', function (value) {
      viewModel.isEditing(!viewModel.isEditing());

      if (value) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.jHueNotify').remove();
        isAssistAvailable = viewModel.assistAvailable();
        wasLeftPanelVisible = viewModel.isLeftPanelVisible();
        wasRightPanelVisible = viewModel.isRightPanelVisible();

        if (wasBottomExpanded) {
          utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish('both.assists.hide', true);
        } else {
          utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish('right.assist.hide', true);
        }
        ...
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.add-snippet').hide(); // if (window.BANNER_TOP_HTML) {
        ...
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish(_events__WEBPACK_IMPORTED_MODULE_12__.HIDE_FIXED_HEADERS_EVENT);
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish('both.assists.revert', true);
        viewModel.assistWithoutStorage(true);
        ...
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.add-snippet').show(); // if (window.BANNER_TOP_HTML) {
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('show.retry.modal', function (data) {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('#editorRetryModal').modal('show');
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('hide.retry.modal', function (data) {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('#editorRetryModal' + window.EDITOR_SUFFIX).modal('hide');
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('open.link', function (link) {
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('editor.presentation.toggle', function () {
      viewModel.selectedNotebook().isPresentationMode(!viewModel.isPresentationMode());
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('editor.save', saveKeyHandler, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('render.jqcron', function () {
      if (typeof window.renderJqCron !== 'undefined') {
        window.renderJqCron();
      }
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('submit.popup.return', function (data) {
      ...
      utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish('show.jobs.panel', {
        id: data.job_id,
        "interface": data.type
      });
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('jobbrowser.data', function (jobs) {
      viewModel.withActiveSnippet(function (snippet) {
        if (!snippet || snippet.dialect() === _snippet__WEBPACK_IMPORTED_MODULE_14__.DIALECT.impala) {
          return;
        }
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('editor.get.active.risks', function (callback) {
      var result = {
        editor: undefined,
        risks: {}
      };
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.subscribe('recalculate.name.description.width', function () {
      (0,utils_timing_waitForRendered__WEBPACK_IMPORTED_MODULE_11__.default)('.editorComponents .hue-title-bar .query-name', function (el) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).on('editorSizeChanged', function () {
      window.setTimeout(function () {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish(_events__WEBPACK_IMPORTED_MODULE_12__.REDRAW_CHART_EVENT);
      }, 50);
    });
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).on('renderDataError', function (e, options) {
      utils_huePubSub__WEBPACK_IMPORTED_MODULE_8__.default.publish(_events__WEBPACK_IMPORTED_MODULE_12__.SHOW_NORMAL_RESULT_EVENT);
    });
    var hideTimeout = -1;
...
var NAME = 'paginator'; // prettier-ignore
...
var NAME = 'saved-queries'; // prettier-ignore
...
var SavedQueries = /*#__PURE__*/function (_DisposableComponent) {
  ...
  var _super = _createSuper(SavedQueries);
  ...
  _createClass(SavedQueries, [{
    key: "fetchQueries",
    value: function () {
      var _fetchQueries = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var _this2 = this;
...
var Notebook = /*#__PURE__*/function () {
  function Notebook(vm, notebookRaw) {
    ...
    this.loadingScheduler = knockout__WEBPACK_IMPORTED_MODULE_1__.observable(false); // Init
  ...
  _createClass(Notebook, [{
    ...
    key: "save",
    value: function () {
      var _save = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(callback) {
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 15:
                ...
                if (_context2.t4 && _context2.t4.status !== 502) {
                  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).trigger('error', _context2.t4.responseText);
                }
    ...
    key: "toContextJson",
    value: function () {
      var _toContextJson = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    key: "toJs",
    value: function () {
      var _toJs = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
    ...
    key: "toJson",
    value: function () {
      var _toJson = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
...
/******/ __webpack_require__.O(0, ["notebook~editor","defaultVendors~hue-cdd60c62","defaultVendors~hue-ae502bed","defaultVendors~hue-536eaa00","defaultVendors~hue-efdee510","defaultVendors~hue-9241dc7c","defaultVendors~hue-0bc0478e","defaultVendors~hue-5a94f17d","hue-297e4d61","hue-f8e792d3","hue-5fffb0b9","hue-e4b7453b","hue-87be45a4","hue-6cfda4b7","hue-6a17ff01","hue-1a95d36b","hue-0320b821","hue-c6b8d6e2","hue-38c7c0b7","hue-24430858","hue-8c9fb242","hue-47193aa1","hue-9a7a1348"], () => (__webpack_exec__("./desktop/core/src/desktop/js/apps/editor/app.js")));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ }
]);
//# sourceMappingURL=/static/desktop/js/bundles/hue/editor-bundle-3c690b33b5f47cc0d68b.js.map