 ...
 *
 */
(self["webpackChunkgethue"] = self["webpackChunkgethue"] || []).push([["hive-ref"],{
...
// See the License for the specific language governing permissions and
// limitations under the License.
var RESERVED_WORDS = new Set(['ALL', 'ALTER', 'AND', 'ARRAY', 'AS', 'ASC', 'AUTHORIZATION', 'BETWEEN', 'BIGINT', 'BINARY', 'BOOLEAN', 'BOTH', 'BY', 'CACHE', 'CASE', 'CAST', 'CHAR', 'CLUSTER', 'COLUMN', 'COMMIT', 'CONF', 'CONSTRAINT', 'CREATE', 'CROSS', 'CUBE', 'CURRENT', 'CURRENT_DATE', 'CURRENT_TIMESTAMP', 'CURSOR', 'DATABASE', 'DATE', 'DAYOFWEEK', 'DECIMAL', 'DELETE', 'DESC', 'DESCRIBE', 'DISTINCT', 'DISTRIBUTE', 'DOUBLE', 'DROP', 'ELSE', 'END', 'EXCHANGE', 'EXISTS', 'EXTENDED', 'EXTERNAL', 'EXTRACT', 'FALSE', 'FETCH', 'FLOAT', 'FLOOR', 'FOLLOWING', 'FOR', 'FOREIGN', 'FORMATTED', 'FROM', 'FULL', 'FUNCTION', 'FUNCTION', 'GRANT', 'GROUP', 'GROUPING', 'HAVING', 'IF', 'IMPORT', 'IN', 'INDEX', 'INDEXES', 'INNER', 'INSERT', 'INT', 'INTEGER', 'INTERSECT', 'INTERVAL', 'INTO', 'IS', 'JOIN', 'LATERAL', 'LEFT', 'LESS', 'LIKE', 'LIMIT', 'LOCAL', 'LOCK', 'MACRO', 'MAP', 'MORE', 'NONE', 'NOT', 'NULL', 'NUMERIC', 'OF', 'ON', 'ONLY', 'OR', 'ORDER', 'OUT', 'OUTER', 'OVER', 'PARTIALSCAN', 'PARTITION', 'PERCENT', 'PRECEDING', 'PRECISION', 'PRESERVE', 'PRIMARY', 'PROCEDURE', 'RANGE', 'READS', 'REDUCE', 'REFERENCES', 'REGEXP', 'REVOKE', 'RIGHT', 'RLIKE', 'ROLLBACK', 'ROLLUP', 'ROW', 'ROWS', 'SCHEMA', 'SELECT', 'SET', 'SMALLINT', 'SORT', 'START', 'SYNC', 'TABLE', 'TABLESAMPLE', 'THEN', 'TIME', 'TIMESTAMP', 'TO', 'TRANSFORM', 'TRIGGER', 'TRUE', 'TRUNCATE', 'UNBOUNDED', 'UNION', 'UNIQUEJOIN', 'UPDATE', 'USER', 'USING', 'UTC_TMESTAMP', 'VALUES', 'VARCHAR', 'VIEWS', 'WHEN', 'WHERE', 'WINDOW', 'WITH']);
...
var DATE_FUNCTIONS = {
  ...
  trunc: {
    ...
    arguments: [[{
      ...
      type: 'STRING',
      keywords: ["'MONTH'", "'MON'", "'MM'", "'YEAR'", "'YYYY'", "'YY'"]
    }]],
...
var STRING_FUNCTIONS = {
  ...
  decode: {
    ...
    arguments: [[{
      ...
      type: 'STRING',
      keywords: ["'US-ASCII'", "'ISO-8859-1'", "'UTF-8'", "'UTF-16BE'", "'UTF-16LE'", "'UTF-16'"]
    }]],
...
var UDF_CATEGORIES = [{
  ...
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__.default)('Collection'),
  functions: COLLECTION_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__.default)('Complex Type'),
  functions: COMPLEX_TYPE_CONSTRUCTS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__.default)('Conditional'),
  functions: CONDITIONAL_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__.default)('Date'),
  functions: DATE_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__.default)('Mathematical'),
  functions: MATHEMATICAL_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__.default)('Misc'),
  functions: MISC_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__.default)('String'),
  functions: STRING_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__.default)('Data Masking'),
  functions: DATA_MASKING_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__.default)('Table Generating'),
  functions: TABLE_GENERATING_FUNCTIONS
}, {
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__.default)('Type Conversion'),
...
//# sourceMappingURL=/static/desktop/js/bundles/hue/hive-ref-chunk-3c690b33b5f47cc0d68b.js.map