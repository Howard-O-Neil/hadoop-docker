 ...
 *
 */
(self["webpackChunkgethue"] = self["webpackChunkgethue"] || []).push([["hive-parser-42c8e9d1"],{
...
"use strict";
module.exports = JSON.parse('{"ALTER":["DATABASE","INDEX","MATERIALIZED VIEW","SCHEDULED QUERY","SCHEMA","TABLE","VIEW"],"ALTER TABLE ADD CONSTRAINT identifier":["CHECK","FOREIGN KEY","PRIMARY KEY","UNIQUE"],"DROP":["DATABASE","FUNCTION","INDEX","MATERIALIZED VIEW","ROLE","SCHEDULED QUERY","SCHEMA","TABLE","TEMPORARY FUNCTION","TEMPORARY MACRO","VIEW"],"SHOW":["COLUMNS","COMPACTIONS","CONF","CREATE TABLE","CURRENT ROLES","DATABASES","FORMATTED","FUNCTIONS","GRANT","INDEX","INDEXES","LOCKS","MATERIALIZED VIEWS","PARTITIONS","PRINCIPALS","ROLE GRANT","ROLES","SCHEMAS","TABLE EXTENDED","TABLES","TBLPROPERTIES","TRANSACTIONS","VIEWS"]}');
...
//# sourceMappingURL=/static/desktop/js/bundles/hue/hive-parser-42c8e9d1-chunk-3c690b33b5f47cc0d68b.js.map