 ...
 *
 */
(self["webpackChunkgethue"] = self["webpackChunkgethue"] || []).push([["impala-parser-d2d0cdc8"],{
    ...
    var _loop = function _loop() {
      ...
      if (location.type === 'table' && typeof location.identifierChain !== 'undefined' && location.identifierChain.length > 1 && tablePrimaries) {
        ...
        var found = allPrimaries.filter(function (primary) {
          return (0,_sqlParseUtils__WEBPACK_IMPORTED_MODULE_1__.equalIgnoreCase)(primary.alias, location.identifierChain[0].name);
        });
      ...
      if (location.type === 'unknown') {
        if (typeof location.identifierChain !== 'undefined' && location.identifierChain.length > 0 && location.identifierChain.length <= 2 && tablePrimaries) {
          ...
          if (_found.length) {
            if (_found[0].identifierChain.length > 1 && location.identifierChain.length === 1 && (0,_sqlParseUtils__WEBPACK_IMPORTED_MODULE_1__.equalIgnoreCase)(_found[0].identifierChain[0].name, location.identifierChain[0].name)) {
              location.type = 'database';
            } else if (_found[0].alias && (0,_sqlParseUtils__WEBPACK_IMPORTED_MODULE_1__.equalIgnoreCase)(location.identifierChain[0].name, _found[0].alias) && location.identifierChain.length > 1) {
              location.type = 'column';
              parser.expandIdentifierChain({
                tablePrimaries: tablePrimaries,
                wrapper: location,
            ...
            } else if (!_found[0].alias && _found[0].identifierChain && (0,_sqlParseUtils__WEBPACK_IMPORTED_MODULE_1__.equalIgnoreCase)(location.identifierChain[0].name, _found[0].identifierChain[_found[0].identifierChain.length - 1].name) && location.identifierChain.length > 1) {
              location.type = 'column';
              parser.expandIdentifierChain({
                tablePrimaries: tablePrimaries,
                wrapper: location,
  ...
  parser.expandImpalaIdentifierChain = function (tablePrimaries, identifierChain) {
    ...
    var expand = function expand(identifier, expandedChain) {
      var foundPrimary = tablePrimaries.filter(function (tablePrimary) {
        ...
        return (0,_sqlParseUtils__WEBPACK_IMPORTED_MODULE_1__.equalIgnoreCase)(primaryIdentifier, identifier);
      });

      if (foundPrimary.length === 1 && foundPrimary[0].identifierChain) {
        var parentPrimary = tablePrimaries.filter(function (tablePrimary) {
          return (0,_sqlParseUtils__WEBPACK_IMPORTED_MODULE_1__.equalIgnoreCase)(tablePrimary.alias, foundPrimary[0].identifierChain[0].name);
        });
...
//# sourceMappingURL=/static/desktop/js/bundles/hue/impala-parser-d2d0cdc8-chunk-3c690b33b5f47cc0d68b.js.map