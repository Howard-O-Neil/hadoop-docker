  ...
  function keyHandler(handleObj) {
    ...
    handleObj.handler = function (event) {
      ...
      var special = event.type !== "keypress" && jQuery.hotkeys.specialKeys[event.which],
          ...
          key,
          modif = "",
          possible = {}; // check combinations (alt|ctrl|shift+anything)
...
/* harmony import */ var utils_screen_scrollbarWidth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! utils/screen/scrollbarWidth */ "./desktop/core/src/desktop/js/utils/screen/scrollbarWidth.ts");
// Licensed to Cloudera, Inc. under one
// or more contributor license agreements.  See the NOTICE file
// distributed with this work for additional information
// regarding copyright ownership.  Cloudera, Inc. licenses this file
...
function Plugin(element, options) {
  ...
  this.options.labels = $.extend({}, defaults.labels, {
    GO_TO_COLUMN: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_1__.default)('Go to column:'),
    PLACEHOLDER: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_1__.default)('column name...'),
    LOCK: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_1__.default)('Lock this row'),
    UNLOCK: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_1__.default)('Unlock this row'),
    ROW_DETAILS: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_1__.default)('Show row details')
...
Plugin.prototype.init = function (optionalPath) {
  ...
  if (_this.options.home != '') {
    ...
    _homeLink.css({
      ...
      width: 560 - (0,utils_screen_scrollbarWidth__WEBPACK_IMPORTED_MODULE_2__.default)() + 'px'
    });
  }
...
//# sourceMappingURL=/static/desktop/js/bundles/hue/notebook~editor-bundle-3c690b33b5f47cc0d68b.js.map