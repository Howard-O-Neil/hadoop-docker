 ...
 *
 */
(self["webpackChunkgethue"] = self["webpackChunkgethue"] || []).push([["impala-ref"],{
...
var DATE_FUNCTIONS = {
  ...
  date_part: {
    ...
    arguments: [[{
      type: 'STRING',
      keywords: ["'epoch'", "'year'", "'quarter'", "'month'", "'day'", "'hour'", "'minute'", "'second'", "'millisecond'"]
    }], [{
      type: 'TIMESTAMP'
    }]],
  ...
  date_trunc: {
    ...
    arguments: [[{
      type: 'STRING',
      keywords: ["'microseconds'", "'milliseconds'", "'second'", "'minute'", "'hour'", "'day'", "'week'", "'month'", "'year'", "'decade'", "'century'", "'millennium'"]
    }], [{
      type: 'TIMESTAMP'
    }]],
  ...
  next_day: {
    ...
    arguments: [[{
      ...
      type: 'STRING',
      keywords: ["'Sunday'", "'Sun'", "'Monday'", "'Mon'", "'Tuesday'", "'Tue'", "'Wednesday'", "'Wed'", "'Thursday'", "'Thu'", "'Friday'", "'Fri'", "'Saturday'", "'Sat'"]
    }]],
  ...
  trunc: {
    ...
    arguments: [[{
      ...
      type: 'STRING',
      keywords: ["'SYYYY'", "'YYYY'", "'YEAR'", "'SYEAR'", "'YYY'", "'YY'", "'Y'", "'Q'", "'MONTH'", "'MON'", "'MM'", "'RM'", "'WW'", "'W'", "'DDD'", "'DD'", "'J'", "'DAY'", "'DY'", "'D'", "'HH'", "'HH12'", "'HH24'", "'MI'"]
    }]],
...
var UDF_CATEGORIES = [{
  ...
  name: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_0__.default)('Bit'),
  functions: BIT_FUNCTIONS
}, {
...
//# sourceMappingURL=/static/desktop/js/bundles/hue/impala-ref-chunk-3c690b33b5f47cc0d68b.js.map