 ...
 *
 */
(self["webpackChunkgethue"] = self["webpackChunkgethue"] || []).push([["hue-1a95d36b"],{
...
!function (a) {
  ...
  a.fn.editableutils.inherit(b, a.fn.editabletypes.list), a.extend(b.prototype, {
    ...
    sorter: function sorter(a) {
      for (var b, c, d = [], e = [], f = []; b = a.shift();) {
        c = b.text, c.toLowerCase().indexOf(this.query.toLowerCase()) ? ~c.indexOf(this.query) ? e.push(b) : f.push(b) : d.push(b);
      }
...
!function (e) {
  ...
  return function () {
    ...
    function h() {
      for (var e = E || t.event.target; "undefined" == typeof e.getScreenCTM && "undefined" === e.parentNode;) {
        e = e.parentNode;
      }
    ...
    e.show = function () {
      ...
      for (i.html(r).style("opacity", 1).style("pointer-events", "all"); f--;) {
        i.classed(S[f], !1);
      }
...
//# sourceMappingURL=/static/desktop/js/bundles/hue/hue-1a95d36b-bundle-3c690b33b5f47cc0d68b.js.map