 ...
 *
 */
(self["webpackChunkgethue"] = self["webpackChunkgethue"] || []).push([["hue-24430858"],{
...
/* harmony import */ var _plugins_jquery_notify__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./plugins/jquery.notify */ "./desktop/core/src/desktop/js/jquery/plugins/jquery.notify.js");
/* harmony import */ var _plugins_jquery_rowselector__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./plugins/jquery.rowselector */ "./desktop/core/src/desktop/js/jquery/plugins/jquery.rowselector.js");
/* harmony import */ var _plugins_jquery_scrollleft__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./plugins/jquery.scrollleft */ "./desktop/core/src/desktop/js/jquery/plugins/jquery.scrollleft.js");
/* harmony import */ var _plugins_jquery_scrollup__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./plugins/jquery.scrollup */ "./desktop/core/src/desktop/js/jquery/plugins/jquery.scrollup.js");
/* harmony import */ var _plugins_jquery_selector__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./plugins/jquery.selector */ "./desktop/core/src/desktop/js/jquery/plugins/jquery.selector.js");
/* harmony import */ var _plugins_jquery_tableextender__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./plugins/jquery.tableextender */ "./desktop/core/src/desktop/js/jquery/plugins/jquery.tableextender.js");
/* harmony import */ var _plugins_jquery_tableextender2__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./plugins/jquery.tableextender2 */ "./desktop/core/src/desktop/js/jquery/plugins/jquery.tableextender2.js");
/* harmony import */ var _plugins_jquery_tablescroller__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./plugins/jquery.tablescroller */ "./desktop/core/src/desktop/js/jquery/plugins/jquery.tablescroller.js");
/* harmony import */ var _plugins_jquery_titleupdater__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./plugins/jquery.titleupdater */ "./desktop/core/src/desktop/js/jquery/plugins/jquery.titleupdater.js");
// Licensed to Cloudera, Inc. under one
// or more contributor license agreements.  See the NOTICE file
// distributed with this work for additional information
// regarding copyright ownership.  Cloudera, Inc. licenses this file
...
if (!(jquery__WEBPACK_IMPORTED_MODULE_0___default().clean)) {
  ...
  (jquery__WEBPACK_IMPORTED_MODULE_0___default().clean) = function (elems, context, fragment, scripts) {
    ...
    var ret = [];
    jquery__WEBPACK_IMPORTED_MODULE_0___default().merge(ret, jquery__WEBPACK_IMPORTED_MODULE_0___default().buildFragment(elems, context).childNodes); // Complex logic lifted directly from jQuery 1.8
      ...
      for (i = 0; (elem = ret[i]) != null; i++) {
        ...
        if (!(jquery__WEBPACK_IMPORTED_MODULE_0___default().nodeName(elem, 'script') && handleScript(elem))) {
          ...
          if (typeof elem.getElementsByTagName !== 'undefined') {
            ...
            jsTags = jquery__WEBPACK_IMPORTED_MODULE_0___default().grep(jquery__WEBPACK_IMPORTED_MODULE_0___default().merge([], elem.getElementsByTagName('script')), handleScript); // Splice the scripts into ret after their former ancestor and advance our index beyond them
...
Plugin.prototype.init = function () {
  ...
  if (_this.options.fn != null) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(_this.element).on(event, function (e) {
...
var DEFAULT_I18n = {
  BACK: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Back'),
  SELECT_FOLDER: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Select this folder'),
  CREATE_FOLDER: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Create folder'),
  FOLDER_NAME: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Folder name'),
  CANCEL: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Cancel'),
  FILE_NOT_FOUND: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('The file has not been found'),
  UPLOAD_FILE: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Upload a file'),
  FAILED: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_4__.default)('Failed')
};
...
Plugin.prototype.setOptions = function (options) {
  ...
  if (self.options.forceRefresh) {
    ...
    } else if ((0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_5__.hueLocalStorage)(STORAGE_PREFIX + self.options.user + self.options.fsSelected) != null) {
      self.navigateTo((0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_5__.hueLocalStorage)(STORAGE_PREFIX + self.options.user + self.options.fsSelected));
    } else {
  ...
  if (filesystemsFiltered.length > 1) {
    ...
    filesystemsFiltered.forEach(function (fs) {
      ...
      $li.on('click', function () {
        ...
        var storedPath = (0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_5__.hueLocalStorage)(STORAGE_PREFIX + self.options.user + self.options.fsSelected);
...
Plugin.prototype.navigateTo = function (path) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON('/filebrowser/view=' + encodeURIComponent(path) + pageSize, function (data) {
    ...
    if (data.error || data.title != null && data.title == 'Error') {
      ...
      _errorMsg.appendTo(jquery__WEBPACK_IMPORTED_MODULE_0___default()(_parent.element).find('.filechooser-tree')); //TODO: allow user to user breadcrums when there is an error
      ...
      (0,utils_storageUtils__WEBPACK_IMPORTED_MODULE_5__.hueLocalStorage)(STORAGE_PREFIX + _parent.options.user + _parent.options.fsSelected, path);
    ...
    if (!_parent.options.suppressErrors) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).trigger('info', _parent.options.labels.FILE_NOT_FOUND);
    ...
    if (e.status === 404 || e.status === 500) {
      ...
      console.error(e);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).trigger('error', e.statusText);
    }
  });
};
  ...
  new _ext_fileuploader_custom__WEBPACK_IMPORTED_MODULE_2__.default.FileUploader({
    ...
    onComplete: function onComplete(id, fileName, responseJSON) {
      ...
      if (responseJSON.status == -1) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).trigger('error', responseJSON.data);
      } else if (!num_of_pending_uploads) {
        _parent.navigateTo(path);

        utils_huePubSub__WEBPACK_IMPORTED_MODULE_3__.default.publish('assist.' + getFs(getScheme(path)) + '.refresh');
      }
    },
...
Plugin.prototype.init = function () {
  var self = this;
  var $el = jquery__WEBPACK_IMPORTED_MODULE_0___default()(self.element); // creates autocomplete popover
    ...
    if (path.length > 1) {
      ...
      validateTimeout = window.setTimeout(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default().when(self.namespaceDeferred, self.computeDeferred).done(function (namespace, compute) {
          var target = path.pop(); // TODO: Use connectors in hiveautocomplete
...
Plugin.prototype.show = function () {
  ...
  _this.options.message = (0,utils_html_deXSS__WEBPACK_IMPORTED_MODULE_1__.default)(_this.options.message); // escape XSS messages
  ...
  if (_this.options.message !== '' && jquery__WEBPACK_IMPORTED_MODULE_0___default()('.jHueNotify .message').last().text() !== _this.options.message) {
    var el = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#jHueNotify').clone();
    el.removeAttr('id'); // stops all the current animations and resets the style

    el.stop(true);
    el.attr('class', 'alert jHueNotify');
    el.find('.close').hide();

    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.jHueNotify').last().position() != null) {
      el.css('top', jquery__WEBPACK_IMPORTED_MODULE_0___default()('.jHueNotify').last().position().top + jquery__WEBPACK_IMPORTED_MODULE_0___default()('.jHueNotify').last().outerHeight() + MARGIN);
    }
    ...
    if (_this.options.sticky) {
      ...
      el.click(function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).stop(true);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).fadeOut();
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).nextAll('.jHueNotify').animate({
          top: '-=' + (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).outerHeight() + MARGIN)
        }, 200);
      });
      el.show();
    }
...
(jquery__WEBPACK_IMPORTED_MODULE_0___default())[pluginName].info = function (message) {
  new Plugin({
    level: TYPES.INFO,
    message: message
  });
...
(jquery__WEBPACK_IMPORTED_MODULE_0___default())[pluginName].warn = function (message) {
  new Plugin({
    level: TYPES.GENERAL,
    message: message,
    sticky: true
...
(jquery__WEBPACK_IMPORTED_MODULE_0___default())[pluginName].error = function (message) {
  new Plugin({
    level: TYPES.ERROR,
    message: message,
    sticky: true
...
(jquery__WEBPACK_IMPORTED_MODULE_0___default())[pluginName].notify = function (options) {
  new Plugin(options);
};
...
window.Selectize = (selectize__WEBPACK_IMPORTED_MODULE_0___default());
...
var AceLocationHandler = /*#__PURE__*/function () {
  ...
  _createClass(AceLocationHandler, [{
                ...
                if (token.parseLocation) {
                  ...
                  if (token.parseLocation.type === 'column') {
                    ...
                    if (tableChain.length > 0 && lastIdentifier && lastIdentifier.name) {
                      var colName = lastIdentifier.name.toLowerCase(); // Note, as cachedOnly is set to true it will call the successCallback right away (or not at all)
      ...
      var updateActiveStatement = function updateActiveStatement(cursorChange) {
        ...
        if (!equalPositions(selectionRange.start, selectionRange.end)) {
          if (!cursorChange && self.snippet.result && self.snippet.result.statement_range()) {
            var executingStatement = self.snippet.result.statement_range(); // Row and col are 0 for both start and end on execute, so if the selection hasn't changed we'll use last known executed statement
    ...
    value: function checkForSyntaxErrors(statementLocation, cursorPosition) {
      ...
      if (self.sqlSyntaxWorkerSub !== null && (self.dialect() === _apps_editor_snippet__WEBPACK_IMPORTED_MODULE_2__.DIALECT.impala || self.dialect() === _apps_editor_snippet__WEBPACK_IMPORTED_MODULE_2__.DIALECT.hive)) {
        var AceRange = ext_aceHelper__WEBPACK_IMPORTED_MODULE_1__.default.require('ace/range').Range;
    ...
    value: function attachSqlSyntaxWorker() {
      ...
      self.sqlSyntaxWorkerSub = utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe(sql_workers_events__WEBPACK_IMPORTED_MODULE_7__.POST_FROM_SYNTAX_WORKER_EVENT, function (e) {
        ...
        if (e.data.syntaxError && e.data.syntaxError.ruleId && !suppressedRules[e.data.syntaxError.ruleId.toString() + e.data.syntaxError.text.toLowerCase()]) {
          ...
          var token = self.editor.getSession().getTokenAt(e.data.syntaxError.loc.first_line - 1, e.data.syntaxError.loc.first_column + 1); // Don't mark the current edited word as an error if the cursor is at the end of the word
    ...
    value: function verifyExists(tokens, allLocations) {
      ...
      var verify = function verify() {
        ...
        var location = token.parseLocation; // TODO: Verify columns in subqueries, i.e. 'code' in 'select code from (select * from web_logs) wl, customers c;'
        ...
        resolvePathFromTables(location).done(function () {
          ...
          self.fetchPossibleValues(token).done( /*#__PURE__*/function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(possibleValues) {
    ...
    value: function attachSqlWorker() {
      ...
      var locationWorkerSub = utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe(sql_workers_events__WEBPACK_IMPORTED_MODULE_7__.POST_FROM_LOCATION_WORKER_EVENT, function (e) {
        ...
        e.data.locations.forEach(function (location) {
          ...
          var token = self.editor.getSession().getTokenAt(location.location.first_line - 1, location.location.first_column); // Find open UDFs and prevent them from being marked as missing columns, i.e. cos in "SELECT * FROM foo where cos(a|"
          ...
          if (token && token.value) {
            var AceRange = ext_aceHelper__WEBPACK_IMPORTED_MODULE_1__.default.require('ace/range').Range; // The Ace tokenizer also splits on '{', '(' etc. hence the actual value;
        ...
        if (self.dialect() === _apps_editor_snippet__WEBPACK_IMPORTED_MODULE_2__.DIALECT.impala || self.dialect() === _apps_editor_snippet__WEBPACK_IMPORTED_MODULE_2__.DIALECT.hive) {
  ...
  init: function init(element, valueAccessor) {
    ...
    var resizeAce = function resizeAce() {
      window.setTimeout(function () {
        try {
          editor.resize(true);
        } catch (e) {// Can happen when the editor hasn't been initialized
        }
      }, 0);
    };
    ...
    editor.previousSize = 0; // TODO: Get rid of this
      ...
      if (editor.session.getMode().$id === 'ace/mode/pig' && e.args) {
        ...
        if (e.args === "'" && textBefore.toUpperCase().indexOf('LOAD ') > -1 && textBefore.toUpperCase().indexOf('LOAD ') === textBefore.toUpperCase().length - 5 || textBefore.toUpperCase().indexOf("LOAD '") > -1 && textBefore.toUpperCase().indexOf("LOAD '") === textBefore.toUpperCase().length - 6) {
          ...
          btn.on('click', function (ie) {
            ie.preventDefault(); // TODO: Turn the ace file chooser into a component and remove css class references
...
knockout__WEBPACK_IMPORTED_MODULE_2__.bindingHandlers.barChart = {
  ...
  update: function update(element, valueAccessor) {
    ...
    if (_options.type && _options.type() !== jquery__WEBPACK_IMPORTED_MODULE_0___default()(element).data('type')) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(element).data('type', _options.type());
    }
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(element).data('mapData') == null || jquery__WEBPACK_IMPORTED_MODULE_0___default()(element).data('mapData') !== knockout__WEBPACK_IMPORTED_MODULE_1__.toJSON(_data) || _options.forceRedraw) {
      ...
      if (_hasAtLeastOneLat && _hasAtLeastOneLng) {
        try {
          if (_map == null) {
            ...
            if (_options.showMoveCheckbox) {
              ...
              _map.on('viewreset', function () {
                utils_huePubSub__WEBPACK_IMPORTED_MODULE_6__.default.publish('leaflet.afterplot', element);
              });
            }
          }
          ...
          var resizeSubscription = utils_huePubSub__WEBPACK_IMPORTED_MODULE_6__.default.subscribe('resize.leaflet.map', function () {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default().jHueNotify.error(err.message);
        }
      }
...
function Datamap(options) {
  ...
  this.addPlugin('labels', handleLabels); //append style block with basic hoverover styles
...
Datamap.prototype.updatePopup = function (element, d, options) {
  ...
  element.on('mousemove', function () {
    ...
    d3.select(self.svg[0][0].parentNode).select('.datamaps-hoverover').style('top', position[1] + 30 + 'px').html(function () {
      var data = JSON.parse(element.attr('data-info')); //if ( !data ) return '';
...
Datamap.prototype.addPlugin = function (name, pluginFn) {
  if (typeof Datamap.prototype[name] === 'undefined') {
    Datamap.prototype[name] = function (data, options, callback, createNewLayer) {
      ...
      options = defaults(options || {}, defaultOptions[name + 'Config']); //add a single layer, reuse the old layer
...
knockout__WEBPACK_IMPORTED_MODULE_1__.bindingHandlers.assistVerticalResizer = {
  ...
  updateWhenRendered: function updateWhenRendered(element, valueAccessor) {
    ...
    var totalHeight = -1;
    var containerTop = $container.offset().top; // Resizes all containers according to the set ratios
      ...
      $element.on('keyup', function (e) {
        if (e.which === 13) {
          ...
          if (options.closeOnEnter) {
            hideSpinner();
            $element.hueAutocomplete('close'); // Prevent autocomplete on enter
  ...
  return {
    init: function init(element, valueAccessor, allBindingsAccessor) {
      var setup = valueAccessor(),
          ...
          datalist = document.createElement('DATALIST'); // create an associated <datalist> element

      datalist.id = element.getAttribute('list');
      document.body.appendChild(datalist); // when the value is changed, write to the associated myValue observable
    ...
    update: function update(element, valueAccessor) {
      var setup = valueAccessor(),
          ...
          dataItems = knockout__WEBPACK_IMPORTED_MODULE_0__.unwrap(setup.options),
          textProperty = knockout__WEBPACK_IMPORTED_MODULE_0__.unwrap(setup.optionsText); // rebuild list of options when an underlying observable changes
    ...
    function rangeHandler(isStart) {
      ...
      if (startDate.valueOf() > endDate.valueOf()) {
        if (isStart) {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default().jHueNotify.notify({
            level: 'ERROR',
      ...
      var _opts = []; // hide not useful options from interval
...
knockout__WEBPACK_IMPORTED_MODULE_1__.bindingHandlers.datepicker = {
  init: function init(element, valueAccessor, allBindings) {
    ...
    function setDate(d) {
      if (_options.momentFormat) {
        var m = moment(d); // Keep time intact
...
knockout__WEBPACK_IMPORTED_MODULE_2__.bindingHandlers.dropzone = {
  init: function init(element, valueAccessor) {
    ...
    var options = {
      ...
      previewTemplate: '<div class="progress-row">' + '<span class="break-word" data-dz-name></span>' + '<div class="pull-right">' + '<span class="muted" data-dz-size></span>&nbsp;&nbsp;' + '<span data-dz-remove><a href="javascript:undefined;" title="' + (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_3__.default)('Cancel upload') + '"><i class="fa fa-fw fa-times"></i></a></span>' + '<span style="display: none" data-dz-uploaded><i class="fa fa-fw fa-check muted"></i></span>' + '</div>' + '<div class="progress-row-bar" data-dz-uploadprogress></div>' + '</div>',
      ...
      canceled: function canceled() {
        jquery__WEBPACK_IMPORTED_MODULE_1___default().jHueNotify.info((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_3__.default)('The upload has been canceled'));
      },
        ...
        if (file.xhr.response !== '') {
          ...
          if (response && response.status != null) {
            if (response.status !== 0) {
              jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).trigger('error', response.data);

              if (value.onError) {
                value.onError(file.name);
              }
            } else {
              jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).trigger('info', response.path + ' ' + (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_3__.default)('uploaded successfully'));
...
knockout__WEBPACK_IMPORTED_MODULE_1__.bindingHandlers.foreachVisible = {
  ...
  update: function update(element, valueAccessor, allBindings, viewModel, bindingContext) {
    ...
    var id = Math.random(); // This is possibly a parent element that has the foreachVisible binding

    var $parentFVElement = bindingContext.$parentForeachVisible || null;
    var parentId = bindingContext.$parentForeachVisibleId || -1; // This is the element from the parent foreachVisible rendered element that contains
    // this one or container for root

    var $parentFVOwnerElement = $container;
    $element.data('parentForeachVisible', $parentFVElement);
    var depth = bindingContext.$depth || 0; // Locate the owning element if within another foreach visible binding
    ...
    updateVisibleEntryCount(); // In case this element was rendered before use the last known indices
    ...
    var updateLastKnownHeights = function updateLastKnownHeights() {
      ...
      var lastKnownHeights = $parentFVOwnerElement.data('lastKnownHeights'); // Happens when closing first level and the third level is open, disposal tells the parents
    ...
    var render = function render() {
      ...
      $container.data('busyRendering', true); // Save the start and end index for when the list is removed and is shown again.

      $parentFVOwnerElement.data('startIndex', startIndex);
      $parentFVOwnerElement.data('endIndex', endIndex);
      positionList(); // This is to ensure that our afterRender is called (the afterRender of KO below isn't called
    ...
    var onScroll = function onScroll() {
      ...
      setStartAndEndFromScrollTop(); // adds a preload ghost image just on scroll and removes it 200ms after the scroll stops
...
knockout__WEBPACK_IMPORTED_MODULE_1__.bindingHandlers.hueLink = {
  ...
  update: function update(element, valueAccessor) {
    ...
    if (url) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(element).attr('href', '/hue' + (url.indexOf('/') === 0 ? url : '/' + url));
    } else {
...
knockout__WEBPACK_IMPORTED_MODULE_1__.bindingHandlers.select2 = {
  init: function init(element, valueAccessor, allBindingsAccessor, viewModel) {
    ...
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(element); // When the options are in the binding value accessor the data attribute will be used instead of any <select>
  ...
  init: function init(element, valueAccessor) {
      ...
      drag: function drag(event, ui) {
        ...
        dragTimeout = window.setTimeout(function () {
          if (isRightPanel) {
            ...
            $rightPanel.css('width', rightPanelWidth + 'px');
            $contentPanel.css('width', totalWidth - rightPanelWidth + 'px'); // $contentPanel.css("right", rightPanelWidth + $resizer.width());
          } else {
    ...
    function initialPositioning() {
      if (!$container.is(':visible')) {
        ...
        positionPanels(); // Even though the container is visible some slow browsers might not
...
knockout__WEBPACK_IMPORTED_MODULE_2__.bindingHandlers.sqlContextPopover = {
  init: function init(element, valueAccessor, allBindings, viewModel, bindingContext) {
    knockout__WEBPACK_IMPORTED_MODULE_2__.bindingHandlers.click.init(element, function () {
      return function () {
        var options = valueAccessor(); // TODO: Use connector for SQL context popover
  ...
  init: function init(element, valueAccessor, allBindingsAccessor, viewModel) {
    ...
    var _afterRender = function afterRender() {
      ...
      if (options.minWidth) {
        ...
        $tip.css('min-width', options.minWidth); // The min-width might affect the height/width in which case we reposition the popover depending on placement
...
//# sourceMappingURL=/static/desktop/js/bundles/hue/hue-24430858-bundle-3c690b33b5f47cc0d68b.js.map