...
/* harmony import */ var _editor_events__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../editor/events */ "./desktop/core/src/desktop/js/apps/editor/events.js");
/* harmony import */ var sql_workers_hueWorkerHandler__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! sql/workers/hueWorkerHandler */ "./desktop/core/src/desktop/js/sql/workers/hueWorkerHandler.ts");
...
/* harmony import */ var utils_html_bootstrapRatios__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! utils/html/bootstrapRatios */ "./desktop/core/src/desktop/js/utils/html/bootstrapRatios.ts");
/* harmony import */ var utils_screen_scrollbarWidth__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! utils/screen/scrollbarWidth */ "./desktop/core/src/desktop/js/utils/screen/scrollbarWidth.ts");
/* harmony import */ var utils_timing_waitForRendered__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! utils/timing/waitForRendered */ "./desktop/core/src/desktop/js/utils/timing/waitForRendered.ts");
...
utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('app.dom.loaded', function (app) {
  if (app === 'editor' && !window.ENABLE_NOTEBOOK_2 || app === 'notebook') {
    window.MAIN_SCROLLABLE = '.page-content';
    var isLeftNavOpen = false;
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('left.nav.open.toggle', function (val) {
      isLeftNavOpen = val;
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('split.panel.resized', function () {
    ...
    var hideHoverMsg = function hideHoverMsg(vm) {
      if (vm.editorMode()) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(window.EDITOR_BINDABLE_ELEMENT).find('.hoverText').html((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_11__.default)('Drop a SQL file here'));
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(window.EDITOR_BINDABLE_ELEMENT).find('.hoverText').html((0,_utils_i18n__WEBPACK_IMPORTED_MODULE_11__.default)('Drop iPython/Zeppelin notebooks here'));
      }
    ...
    var createHueDatatable = function createHueDatatable(el, snippet, vm) {
      ...
      var _dt = jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).hueDataTable({
        i18n: {
          NO_RESULTS: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_11__.default)('No results found.'),
          OF: (0,_utils_i18n__WEBPACK_IMPORTED_MODULE_11__.default)('of')
        },
    ...
    var createDatatable = function createDatatable(el, snippet, vm) {
      var parent = jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).parent(); // When executing few columns -> many columns -> few columns we have to clear the style
        ...
        if (!vm.editorMode() || vm.editorMode() && snippet.currentQueryTab() === 'queryResults' && snippet.showGrid()) {
          ...
          _scrollTimeout = window.setTimeout(function () {
            ...
            if (_lastScrollPosition !== scrollElement.scrollTop() && scrollElement.scrollTop() + scrollElement.outerHeight() + 20 >= scrollElement[0].scrollHeight && _dt && snippet.result.hasMore()) {
              utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.publish('editor.snippet.result.gray', snippet);
      ...
      utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribeOnce('chart.hard.reset', function () {
    ...
    if (window.EDITOR_ENABLE_QUERY_SCHEDULING) {
      viewModel = new _NotebookViewModel__WEBPACK_IMPORTED_MODULE_7__.default(window.EDITOR_ID, window.NOTEBOOKS_JSON, window.EDITOR_VIEW_MODEL_OPTIONS, window.CoordinatorEditorViewModel, window.RunningCoordinatorModel);
    } else {
      viewModel = new _NotebookViewModel__WEBPACK_IMPORTED_MODULE_7__.default(window.EDITOR_ID, window.NOTEBOOKS_JSON, window.EDITOR_VIEW_MODEL_OPTIONS);
    }
    ...
    viewModel.init();
    (0,sql_workers_hueWorkerHandler__WEBPACK_IMPORTED_MODULE_9__.registerHueWorkers)();
    viewModel.selectedNotebook.subscribe(function (newVal) {
      utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.publish('selected.notebook.changed', newVal);
    });
    ...
    viewModel.isResultFullScreenMode.subscribe(function (newValue) {
      ...
      utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.publish('editor.presentation.operate.toggle', newValue);
    });
    viewModel.isLeftPanelVisible.subscribe(function (value) {
      redrawFixedHeaders(200);
    });
    var ignoreNextUnload = false;
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe(_editor_events__WEBPACK_IMPORTED_MODULE_8__.IGNORE_NEXT_UNLOAD_EVENT, function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.preview-sample').css('right', 10 + (0,utils_screen_scrollbarWidth__WEBPACK_IMPORTED_MODULE_13__.default)() + 'px');
    ...
    var initKeydownBindings = function initKeydownBindings() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).bind('keydown.editor', 'ctrl+shift+p alt+shift+p meta+shift+p', function (e) {
        e.preventDefault();
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.publish('editor.presentation.toggle');
        return false;
      });
    ...
    var resetResultsResizer = function resetResultsResizer(snippet) {
      ...
      $snippet.find('.table-results .column-side').width(utils_html_bootstrapRatios__WEBPACK_IMPORTED_MODULE_12__.default.span3() + '%').data('newWidth', utils_html_bootstrapRatios__WEBPACK_IMPORTED_MODULE_12__.default.span3());

      if (snippet.isResultSettingsVisible()) {
        $snippet.find('.table-results .grid-side').data('newWidth', utils_html_bootstrapRatios__WEBPACK_IMPORTED_MODULE_12__.default.span9()).width(utils_html_bootstrapRatios__WEBPACK_IMPORTED_MODULE_12__.default.span9() + '%');
      } else {
      ...
      $snippet.find('.resize-bar').draggable({
        ...
        create: function create() {
          ...
          $snip.find('.table-results .column-side').data('newWidth', utils_html_bootstrapRatios__WEBPACK_IMPORTED_MODULE_12__.default.span3());
        ...
        drag: function drag(event, ui) {
          ...
          var newSpan3Width = ui.position.left * utils_html_bootstrapRatios__WEBPACK_IMPORTED_MODULE_12__.default.span3() / initialPosition;
          var newSpan9Width = 100 - newSpan3Width - utils_html_bootstrapRatios__WEBPACK_IMPORTED_MODULE_12__.default.margin();
        ...
        stop: function stop() {
          redrawFixedHeaders();
          utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.publish('resize.leaflet.map');
        }
      });
    };
    ...
    forceChartDraws(true); // ======== PubSub ========

    var splitDraggableTimeout = -1;
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('split.draggable.position', function () {
      window.clearTimeout(splitDraggableTimeout);
      splitDraggableTimeout = window.setTimeout(function () {
        redrawFixedHeaders(100);
      }, 200);
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('redraw.fixed.headers', function () {
      hideFixedHeaders();
      redrawFixedHeaders(200);
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('app.gained.focus', function (app) {
      if (app === 'editor') {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.publish('redraw.fixed.headers');
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.publish('hue.scrollleft.show');
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.publish(_editor_events__WEBPACK_IMPORTED_MODULE_8__.ACTIVE_SNIPPET_CONNECTOR_CHANGED_EVENT, viewModel.activeConnector());
      }
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('current.query.tab.switched', function (tab) {
      if (tab !== 'queryResults') {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.hue-datatable-search').hide();
      }

      if (tab === 'queryHistory') {
        (0,utils_timing_waitForRendered__WEBPACK_IMPORTED_MODULE_14__.default)(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#queryHistory .history-table'), function (el) {
          return el.is(':visible');
        }, function () {
          viewModel.selectedNotebook().forceHistoryInitialHeight(true);
          utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.publish('editor.calculate.history.height');
        });
      }
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('detach.scrolls', function (snippet) {
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.calculate.history.height', function () {
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.create.new', newKeyHandler, HUE_PUB_SUB_EDITOR_ID);

    if (viewModel.isSqlAnalyzerEnabled()) {
      if (window.SQL_ANALYZER_AUTO_UPLOAD_QUERIES) {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.upload.query', function (query_id) {
          viewModel.selectedNotebook().snippets()[0].uploadQuery(query_id);
        }, HUE_PUB_SUB_EDITOR_ID);
      }

      if (window.SQL_ANALYZER_AUTO_UPLOAD_DDL) {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.upload.table.stats', function (options) {
          viewModel.selectedNotebook().snippets()[0].uploadTableStats(options);
        }, HUE_PUB_SUB_EDITOR_ID);
      }

      if (window.SQL_ANALYZER_QUERY_HISTORY_UPLOAD_LIMIT !== 0) {
        utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.upload.history', function () {
          viewModel.selectedNotebook().snippets()[0].uploadQueryHistory(5);
        }, HUE_PUB_SUB_EDITOR_ID);
      }
    }

    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('get.selected.notebook', function () {
      utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.publish('set.selected.notebook', viewModel.selectedNotebook());
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe(_ko_components_assist_events__WEBPACK_IMPORTED_MODULE_15__.SHOW_LEFT_ASSIST_EVENT, function () {
      if (!viewModel.isLeftPanelVisible() && viewModel.assistAvailable()) {
        viewModel.isLeftPanelVisible(true);
      }
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('assist.set.manual.visibility', function () {
      wasLeftPanelVisible = viewModel.isLeftPanelVisible();
      wasRightPanelVisible = viewModel.isRightPanelVisible();
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.presentation.operate.toggle', function (value) {
      ...
      if (value) {
        ...
        if (wasResultFullScreenMode) {
          ...
          utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.publish('right.assist.hide', true);
        }
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('show.retry.modal', function (data) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#retryModal' + window.EDITOR_SUFFIX).modal('show');
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('hide.retry.modal', function (data) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#retryModal' + window.EDITOR_SUFFIX).modal('hide');
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('open.link', function (link) {
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.presentation.toggle', function () {
      viewModel.selectedNotebook().isPresentationMode(!viewModel.isPresentationMode());
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.save', saveKeyHandler, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.render.data', function (options) {
      ...
      if (options.data.length > 0) {
        window.setTimeout(function () {
          ...
          utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.publish('editor.snippet.result.normal', options.snippet);
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.redraw.data', function (options) {
      (0,utils_timing_waitForRendered__WEBPACK_IMPORTED_MODULE_14__.default)('#snippet_' + options.snippet.id() + ' .resultTable', function (el) {
        return el.is(':visible');
      }, function () {
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.snippet.result.gray', function (snippet) {
      var $snippet = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#snippet_' + snippet.id());
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.snippet.result.normal', function (snippet) {
      var $snippet = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#snippet_' + snippet.id());
      $snippet.find('.dataTables_wrapper .fixed-first-column').css({
        opacity: '1'
      });
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('render.jqcron', function () {
      if (typeof window.renderJqCron !== 'undefined') {
        window.renderJqCron();
      }
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('submit.popup.return', function (data) {
      ...
      utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.publish('show.jobs.panel', {
        id: data.job_id,
        "interface": data.type
      });
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('jobbrowser.data', function (jobs) {
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.get.active.risks', function (callback) {
      var result = {
        editor: undefined,
        risks: {}
      };
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.grid.shown', function (snippet) {
      (0,utils_timing_waitForRendered__WEBPACK_IMPORTED_MODULE_14__.default)('#snippet_' + snippet.id() + ' .dataTables_wrapper', function (el) {
        return el.is(':visible');
      }, function () {
    ...
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('editor.chart.shown', function (snippet) {
      resizeToggleResultSettings(snippet, true);
    }, HUE_PUB_SUB_EDITOR_ID);
    utils_huePubSub__WEBPACK_IMPORTED_MODULE_10__.default.subscribe('recalculate.name.description.width', function () {
      (0,utils_timing_waitForRendered__WEBPACK_IMPORTED_MODULE_14__.default)('.editorComponents .hue-title-bar .query-name', function (el) {
        return el.is(':visible');
      }, function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('toggleResultSettings', function (e, snippet) {
      window.setTimeout(function () {
        ...
        if (snippet.isResultSettingsVisible()) {
          $snip.find('.table-results .grid-side').width(100 - $snip.find('.table-results .column-side').data('newWidth') - utils_html_bootstrapRatios__WEBPACK_IMPORTED_MODULE_12__.default.margin() + '%');
        } else {
...
//# sourceMappingURL=/static/desktop/js/bundles/hue/notebook-bundle-3c690b33b5f47cc0d68b.js.map